...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/profhilo-ba1-1.jpg", after: "/assets/treatments/profhilo-ba1-2.jpg", label: "Crow's feet and crepiness", name: "Maria C.", review: "The little lines fanning out from my eye were the thing that aged me. They sit softer now and the skin feels firmer to touch." },
    { before: "/assets/treatments/profhilo-ba2-1.jpg", after: "/assets/treatments/profhilo-ba2-2.jpg", label: "Forehead lines", name: "Mark B.", review: "My forehead creases were really set in before. They have settled a lot and the skin looks smoother even when I lift my brows." },
    { before: "/assets/treatments/profhilo-ba3-1.jpg", after: "/assets/treatments/profhilo-ba3-2.jpg", label: "Under-eye crepiness", name: "Elena V.", review: "That crepey patch under my eye used to catch the light. It looks plumper now and a good bit smoother, really pleased." },
    { before: "/assets/treatments/profhilo-ba4-1.jpg", after: "/assets/treatments/profhilo-ba4-2.jpg", label: "Tired, dull skin", name: "Roberta F.", review: "My skin had gone flat and tired looking. Now it has a healthier glow and feels fresher, which is exactly what I was after." },
    { before: "/assets/treatments/profhilo-ba5-1.jpg", after: "/assets/treatments/profhilo-ba5-2.jpg", label: "Forehead lines", name: "Daniela M.", review: "The lines across my forehead are softer. Not completely gone, but a clear difference, and the skin itself feels smoother." },
    { before: "/assets/treatments/profhilo-ba6-1.jpg", after: "/assets/treatments/profhilo-ba6-2.jpg", label: "Lines around the mouth", name: "Christine A.", review: "Those fine lines creeping around my mouth and chin had started bothering me. The area looks calmer now and feels more hydrated." },
    { before: "/assets/treatments/profhilo-ba7-1.jpg", after: "/assets/treatments/profhilo-ba7-2.jpg", label: "Mid-face crepiness", name: "Nadia S.", review: "My cheeks and under-eyes looked a bit tired and crepey before. They seem firmer and brighter now, happy with how it came out." },
    { before: "/assets/treatments/profhilo-ba8-1.jpg", after: "/assets/treatments/profhilo-ba8-2.jpg", label: "Lower-face lines", name: "Sandra P.", review: "The skin around my mouth and chin had a crepey look to it. It feels plumper and smoother now and the lines are far less obvious." },
    { before: "/assets/treatments/profhilo-ba9-1.jpg", after: "/assets/treatments/profhilo-ba9-2.jpg", label: "Fine lines and dullness", name: "Lara D.", review: "The faint lines on my face have eased and the skin feels more hydrated. It looks a touch more even too, which I noticed straight away." },
    { before: "/assets/treatments/profhilo-ba10-1.jpg", after: "/assets/treatments/profhilo-ba10-2.jpg", label: "Skin texture and pores", name: "Joanne G.", review: "My cheek felt rough and the pores looked bigger than I liked. It is smoother now and the texture has really settled down." },
  ],
  precision: {
