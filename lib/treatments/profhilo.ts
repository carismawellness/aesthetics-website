...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/profhilo-ba1-1.jpg", after: "/assets/treatments/profhilo-ba1-2.jpg", label: "Crow's feet and crepiness", name: "Maria C.", review: "The little lines fanning out from my eye were what aged me most. They sit softer now and the cheek below feels firmer to touch." },
    { before: "/assets/treatments/profhilo-ba2-1.jpg", after: "/assets/treatments/profhilo-ba2-2.jpg", label: "Forehead lines", name: "Mark B.", review: "My forehead creases were really set in. They have eased a fair bit and the skin looks smoother now, even when I lift my brows." },
    { before: "/assets/treatments/profhilo-ba3-1.jpg", after: "/assets/treatments/profhilo-ba3-2.jpg", label: "Under-eye crepiness", name: "Elena V.", review: "That crepey bit at the corner of my eye used to catch the light. It looks plumper now and a good deal smoother, really pleased." },
    { before: "/assets/treatments/profhilo-ba4-1.jpg", after: "/assets/treatments/profhilo-ba4-2.jpg", label: "Tired, dull skin", name: "Roberta F.", review: "My skin had gone flat and tired looking. Now it has more of a glow and feels fresher, which is exactly what I was after." },
    { before: "/assets/treatments/profhilo-ba5-1.jpg", after: "/assets/treatments/profhilo-ba5-2.jpg", label: "Forehead lines", name: "Daniela M.", review: "The lines across my forehead are noticeably fainter. Not gone completely, but a clear difference, and the skin itself feels smoother." },
    { before: "/assets/treatments/profhilo-ba6-1.jpg", after: "/assets/treatments/profhilo-ba6-2.jpg", label: "Lines around the mouth", name: "Christine A.", review: "Those fine lines creeping around my mouth and chin had started bothering me. The whole area looks calmer now and feels more hydrated." },
    { before: "/assets/treatments/profhilo-ba7-1.jpg", after: "/assets/treatments/profhilo-ba7-2.jpg", label: "Mid-face crepiness", name: "Nadia S.", review: "My cheeks and under-eyes looked a bit tired and crepey before. The skin seems firmer and brighter now, happy with how it came out." },
    { before: "/assets/treatments/profhilo-ba8-1.jpg", after: "/assets/treatments/profhilo-ba8-2.jpg", label: "Lower-face texture", name: "Sandra P.", review: "The skin beside my nose felt rough and the pores stood out. It is smoother now and sits plumper, the lines near my mouth are softer too." },
    { before: "/assets/treatments/profhilo-ba9-1.jpg", after: "/assets/treatments/profhilo-ba9-2.jpg", label: "Neck lines and crepiness", name: "Nadia B.", review: "The lines across my neck were the thing I noticed most. They have eased a fair bit and the skin there looks smoother than before." },
    { before: "/assets/treatments/profhilo-ba10-1.jpg", after: "/assets/treatments/profhilo-ba10-2.jpg", label: "Skin texture and pores", name: "Joanne G.", review: "My skin used to feel rough with pores that showed. It looks more refined now and the texture has settled down nicely overall." },
  ],
  precision: {
