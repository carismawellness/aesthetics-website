...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/ultimate-facelift-ba1-1.jpg", after: "/assets/treatments/ultimate-facelift-ba1-2.jpg", label: "Jawline and neck laxity", name: "Maria F.", review: "My jawline and neck had really dropped over the last couple of years. The lower part of my face sits tighter now and looks a bit more lifted." },
    { before: "/assets/treatments/ultimate-facelift-ba2-1.jpg", after: "/assets/treatments/ultimate-facelift-ba2-2.jpg", label: "Neck skin laxity", name: "Daniela B.", review: "The skin under my chin used to be loose and a little crepey. It feels firmer when I look up now, and smoother to the touch." },
    { before: "/assets/treatments/ultimate-facelift-ba3-1.jpg", after: "/assets/treatments/ultimate-facelift-ba3-2.jpg", label: "Mid-face sagging", name: "Elena C.", review: "My cheeks had gone flat and were pulling down a bit. They look fuller and lifted again, nothing overdone, just more like me." },
    { before: "/assets/treatments/ultimate-facelift-ba4-1.jpg", after: "/assets/treatments/ultimate-facelift-ba4-2.jpg", label: "Brow and jowl laxity", name: "Roberta M.", review: "The heaviness around my brow and jaw was really bothering me. Everything looks lifted and fresher now, and my husband noticed before I even said a word." },
    { before: "/assets/treatments/ultimate-facelift-ba5-1.jpg", after: "/assets/treatments/ultimate-facelift-ba5-2.jpg", label: "Under-chin fullness", name: "Christine V.", review: "The fullness under my chin made my profile look soft. My jawline finally shows now and the whole side view is much more defined." },
    { before: "/assets/treatments/ultimate-facelift-ba6-1.jpg", after: "/assets/treatments/ultimate-facelift-ba6-2.jpg", label: "Marionette lines and jowls", name: "Nadia S.", review: "Those lines running down from the corners of my mouth had got quite deep. They have softened nicely and my mouth sits better now." },
    { before: "/assets/treatments/ultimate-facelift-ba7-1.jpg", after: "/assets/treatments/ultimate-facelift-ba7-2.jpg", label: "Jawline and neck", name: "Julia A.", review: "My lower face felt heavy and a touch jowly. A few weeks on, the jaw looks cleaner and the neck is noticeably tighter than before." },
    { before: "/assets/treatments/ultimate-facelift-ba8-1.jpg", after: "/assets/treatments/ultimate-facelift-ba8-2.jpg", label: "Nasolabial folds", name: "Sandra P.", review: "The folds beside my nose were really set in. They read softer now and my cheek has a bit of lift back to it. Really pleased." },
    { before: "/assets/treatments/ultimate-facelift-ba9-1.jpg", after: "/assets/treatments/ultimate-facelift-ba9-2.jpg", label: "Sagging cheeks and jowls", name: "Antonella G.", review: "My face had started sliding downwards, mostly around the jaw. It looks lifted and firmer, and friends keep telling me I look rested." },
    { before: "/assets/treatments/ultimate-facelift-ba10-1.jpg", after: "/assets/treatments/ultimate-facelift-ba10-2.jpg", label: "Overall facial laxity", name: "Tania R.", review: "The whole lower face had loosened over the years. Now my jaw is more defined and the sagging around my mouth has eased right off." },
  ],
  precision: {
