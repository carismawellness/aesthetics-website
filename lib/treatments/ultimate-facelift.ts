  ...
  beforeAfter: [
    {
      ...
      name: "Daniela M.",
      review: "My cheeks had started to slide and look flat — the lift gave my whole midface its shape back, and it still looks like me.",
    },
    {
      before: "/assets/treatments/thread-lift-malta-ba2-before.png",
      after: "/assets/treatments/thread-lift-malta-ba2-after.png",
      name: "Caroline S.",
      review: "My jawline and neck were the part I hated in photos — now the contour is tighter and defined without any surgery.",
    },
    {
      before: "/assets/treatments/thread-lift-malta-ba3-before.png",
      after: "/assets/treatments/thread-lift-malta-ba3-after.png",
      name: "Marija B.",
      review: "Friends keep asking if I am sleeping better — my face just looks lifted and rested, not done.",
    },
    {
      before: "/assets/treatments/thread-lift-malta-ba4-before.png",
      after: "/assets/treatments/thread-lift-malta-ba4-after.png",
      name: "Elena P.",
      review: "The hollow, tired look under my eyes softened beautifully — my skin feels smoother and firmer than it has in years.",
    },
  ],
  precision: {
