...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba1-1.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba1-2.jpg", label: "Crow's feet and cheek", name: "Maria C.", review: "The deep lines fanning out from my eye have really calmed down. My side profile looks rested now, not all creased when I smile." },
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba2-1.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba2-2.jpg", label: "Crow's feet lines", name: "Elena B.", review: "Mostly I noticed the crepey bit under my eye smoothing out. Still looks like me, just a little less tired around the eyes." },
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba3-1.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba3-2.jpg", label: "Lines around the mouth", name: "Roberta F.", review: "Those lines running down toward my mouth used to bug me in photos. They have softened and the cheek sits a lot smoother now." },
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba4-1.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba4-2.jpg", label: "Forehead lines", name: "Daniela M.", review: "Honestly a small change but my forehead is much smoother and my eyes look more open. I didn't want anything frozen and it still moves." },
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba5-1.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba5-2.jpg", label: "Forehead and frown lines", name: "Nadia P.", review: "My forehead used to crease the second I lifted my brows. Now it stays smooth and I can still make faces, which is what I wanted." },
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba6-1.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba6-2.jpg", label: "Crow's feet creasing", name: "Christine A.", review: "The little fan of lines beside my eye relaxed nicely. Took about a week to settle and I'm happy with how subtle it stayed." },
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba7-1.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba7-2.jpg", label: "Crow's feet and cheek", name: "Lucia G.", review: "Quite a change around the eye and cheek. The crease lines are softer and the skin looks a touch fresher than before." },
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba8-1.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba8-2.jpg", label: "Crow's feet lines", name: "Sofia R.", review: "I only had the corners of my eyes done. The creasing when I smile is gentler now and nothing about it looks overdone." },
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba9-1.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba9-2.jpg", label: "Frown lines between brows", name: "Antonella V.", review: "That line between my brows that made me look cross has properly settled. A few people said I seem less stressed, so I'll take it." },
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba10-1.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba10-2.jpg", label: "Forehead and frown lines", name: "Charlene S.", review: "My forehead lines were the main thing and they have smoothed out well. Skin looks brighter too, and the appointment was quick, no fuss." },
  ],
  precision: {
