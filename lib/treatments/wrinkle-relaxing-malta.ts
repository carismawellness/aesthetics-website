...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba1-1.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba1-2.jpg", label: "crow's feet softened", name: "Marlene B.", review: "The deep lines fanning from the corner of my eye have flattened right out. My cheek looks smoother when I smile now." },
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba2-1.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba2-2.jpg", label: "eye area lines", name: "Doris V.", review: "The crinkling around and under my eye has settled. That side of my face reads as more rested than it used to." },
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba3-1.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba3-2.jpg", label: "lower face creasing", name: "Annette P.", review: "The fine creasing running down my cheek toward my jaw has eased off. The skin there sits flatter and feels firmer." },
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba4-2.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba4-1.jpg", label: "forehead lines smoothed", name: "Karin S.", review: "The horizontal lines across my forehead have settled and the area looks calmer. My face no longer reads as tense." },
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba5-1.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba5-2.jpg", label: "frown line relaxed", name: "Theresa M.", review: "The crease between my brows has softened and my eyes look less weary. People keep saying I seem well rested." },
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba6-1.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba6-2.jpg", label: "crow's feet eased", name: "Joan R.", review: "The little spray of lines at the corner of my eye has quietened down. The skin beside my eye looks smoother." },
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba7-1.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba7-2.jpg", label: "crow's feet reduced", name: "Carmen L.", review: "The lines that ran from my eye down onto my cheek are far less obvious. That whole area looks fresher to me." },
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba8-1.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba8-2.jpg", label: "crow's feet eased", name: "Sandra K.", review: "The creases at both eyes have flattened. When I smile they no longer dig in the way they always did before." },
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba9-1.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba9-2.jpg", label: "frown line softened", name: "Rita C.", review: "The crease above my nose and the lines at my eye have both eased. My expression looks more open and relaxed." },
    { before: "/assets/treatments/wrinkle-relaxing-malta-ba10-1.jpg", after: "/assets/treatments/wrinkle-relaxing-malta-ba10-2.jpg", label: "forehead lines relaxed", name: "Elena F.", review: "The faint lines on my forehead have settled and the shadows under my eyes look lighter. My skin seems brighter." },
  ],
  precision: {
