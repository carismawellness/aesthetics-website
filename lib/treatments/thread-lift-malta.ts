...
const t: Treatment = {
  ...
  category: "Face",
  hero: {
    title: "Thread Lift in Malta — Non-Surgical Facelift by Doctors",
  ...
  precision: {
    title: "How Thread Lifting Works — Precision Placement",
  ...
  suitability: {
    title: "Who Is a Good Candidate for a Thread Lift?",
  ...
  experience: {
    title: "Your Thread Lift Results — What to Expect",
    steps: [
  ...
  prepAftercare: {
    ...
    title: "Aftercare and Recovery After Your Thread Lift",
  ...
  trusted: {
    title: "Medically Qualified Practitioners — Safe Thread Lift",
  ...
  difference: {
    ...
    title: "What Is a Thread Lift? Doctor-Led Lifting in Malta",
  ...
  recommended: {
    title: "Book Your Thread Lift Consultation in Malta Today",
    items: [
  ...
  faqTitle: "Frequently Asked Questions About Thread Lift in Malta",
  faq: [
