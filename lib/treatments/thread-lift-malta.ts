...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/thread-lift-malta-ba1-1.jpg", after: "/assets/treatments/thread-lift-malta-ba1-2.jpg", label: "Jawline and jowl lift", name: "Marija C.", review: "My lower face used to look heavy and a bit square. The jawline sits tighter now and the jowls have eased back." },
    { before: "/assets/treatments/thread-lift-malta-ba2-2.jpg", after: "/assets/treatments/thread-lift-malta-ba2-1.jpg", label: "Cheek lift and calm", name: "Elena P.", review: "There was a flushed patch and the cheek had dropped a little. It looks calmer now and sits higher on that side." },
    { before: "/assets/treatments/thread-lift-malta-ba3-1.jpg", after: "/assets/treatments/thread-lift-malta-ba3-2.jpg", label: "Under-eye and cheek", name: "Sofia R.", review: "The shadow under my eye was quite dark. It reads lighter now and the cheek underneath feels more supported." },
    { before: "/assets/treatments/thread-lift-malta-ba4-2.jpg", after: "/assets/treatments/thread-lift-malta-ba4-1.jpg", label: "Cheek firmness lift", name: "Anne M.", review: "The skin across my cheek had softened with age. It feels firmer now and the side of my face looks more even." },
    { before: "/assets/treatments/thread-lift-malta-ba5-1.jpg", after: "/assets/treatments/thread-lift-malta-ba5-2.jpg", label: "Under-eye brightening", name: "Carmen V.", review: "The hollows under my eyes made me look worn out. They sit fuller now and my cheeks feel a little lifted." },
    { before: "/assets/treatments/thread-lift-malta-ba6-1.jpg", after: "/assets/treatments/thread-lift-malta-ba6-2.jpg", label: "Under-eye and cheek", name: "Greta B.", review: "My under-eye looked puffy and the cheek had slipped. After the threads the area sits higher and looks smoother." },
    { before: "/assets/treatments/thread-lift-malta-ba7-1.jpg", after: "/assets/treatments/thread-lift-malta-ba7-2.jpg", label: "Under-eye smoothing lift", name: "Nadia S.", review: "The skin under my eye had gone a bit crepey. It looks smoother now and the cheek sits with more support." },
    { before: "/assets/treatments/thread-lift-malta-ba8-1.jpg", after: "/assets/treatments/thread-lift-malta-ba8-2.jpg", label: "Cheek lift and smoothing", name: "Layla H.", review: "My cheek looked marked and a touch tired before. It reads more even now and feels firmer where it had loosened." },
    { before: "/assets/treatments/thread-lift-malta-ba9-1.jpg", after: "/assets/treatments/thread-lift-malta-ba9-2.jpg", label: "Cheek support lift", name: "Ingrid L.", review: "The cheek had started to slacken and look uneven. It feels tighter now and the side of my face sits higher." },
    { before: "/assets/treatments/thread-lift-malta-ba10-1.jpg", after: "/assets/treatments/thread-lift-malta-ba10-2.jpg", label: "Under-eye and mid face", name: "Dina K.", review: "The dark hollows under my eyes bothered me most. They look softer now and the mid face sits a little fuller." },
  ],
  precision: {
