...
const t: Treatment = {
  ...
  beforeAfter: [
    ...
    { before: "/assets/treatments/thread-lift-malta-ba4-1.jpg", after: "/assets/treatments/thread-lift-malta-ba4-2.jpg", label: "Cheek firmness lift", name: "Anne M.", review: "The skin across my cheek had softened with age. It feels firmer now and the side of my face looks more even." },
