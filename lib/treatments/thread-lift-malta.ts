...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/thread-lift-malta-ba1-1.jpg", after: "/assets/treatments/thread-lift-malta-ba1-2.jpg", label: "Jawline and lower face", name: "Roberta M.", review: "My lower face used to droop a little and now the jaw sits much neater. It looks tighter without looking pulled, which is what I wanted." },
    { before: "/assets/treatments/thread-lift-malta-ba2-1.jpg", after: "/assets/treatments/thread-lift-malta-ba2-2.jpg", label: "Midface and cheek lift", name: "Elena C.", review: "The side of my face feels lifted and the heaviness near my mouth has eased. Still very much me, just a bit fresher in the cheek." },
    { before: "/assets/treatments/thread-lift-malta-ba3-2.jpg", after: "/assets/treatments/thread-lift-malta-ba3-1.jpg", label: "Under-eye and cheek", name: "Nadia B.", review: "The hollow under my eye looks less sunken and my cheek feels firmer. It took a couple of weeks but I notice it every morning." },
    { before: "/assets/treatments/thread-lift-malta-ba4-2.jpg", after: "/assets/treatments/thread-lift-malta-ba4-1.jpg", label: "Mid and lower face", name: "Daniela F.", review: "My cheek and jaw look firmer in profile and the skin reads more even. I was nervous about my age but it settled really naturally." },
    { before: "/assets/treatments/thread-lift-malta-ba5-1.jpg", after: "/assets/treatments/thread-lift-malta-ba5-2.jpg", label: "Under-eye and cheek", name: "Maria S.", review: "The shadow under my eyes is softer and my cheeks sit a touch higher. I look more rested in photos now, which my husband noticed first." },
    { before: "/assets/treatments/thread-lift-malta-ba6-1.jpg", after: "/assets/treatments/thread-lift-malta-ba6-2.jpg", label: "Under-eye and cheek", name: "Christine A.", review: "The puffiness under my eye calmed down and the cheek has a gentle lift to it. Nothing dramatic, just tidier and a bit brighter." },
    { before: "/assets/treatments/thread-lift-malta-ba7-1.jpg", after: "/assets/treatments/thread-lift-malta-ba7-2.jpg", label: "Cheek and midface", name: "Antonella V.", review: "My cheek looks smoother and a little more lifted on that side. Worried it would look done, but honestly nobody could put their finger on it." },
    { before: "/assets/treatments/thread-lift-malta-ba8-1.jpg", after: "/assets/treatments/thread-lift-malta-ba8-2.jpg", label: "Cheek and midface", name: "Sandra P.", review: "The cheek looks firmer and the skin there is clearer than before. A friend asked if I had been away somewhere, which made me laugh." },
    { before: "/assets/treatments/thread-lift-malta-ba9-1.jpg", after: "/assets/treatments/thread-lift-malta-ba9-2.jpg", label: "Cheek and smile lines", name: "Graziella T.", review: "The lines from my nose to mouth softened and my cheek feels supported again. At my age I was not expecting much, so I am quietly pleased." },
    { before: "/assets/treatments/thread-lift-malta-ba10-1.jpg", after: "/assets/treatments/thread-lift-malta-ba10-2.jpg", label: "Cheek and midface", name: "Luana G.", review: "My cheeks look lifted and the lower face is a bit slimmer in the mirror. It came on gradually so it never looked obvious to anyone." },
  ],
  precision: {
