...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/fat-dissolving-malta-ba1-1.jpg", after: "/assets/treatments/fat-dissolving-malta-ba1-2.jpg", label: "Jawline and under-chin fat", name: "Maria C.", review: "The softness under my jaw was what bothered me most. A few weeks on and my profile looks much tidier from the side." },
    { before: "/assets/treatments/fat-dissolving-malta-ba2-1.jpg", after: "/assets/treatments/fat-dissolving-malta-ba2-2.jpg", label: "Lower-face jaw fullness", name: "Elena B.", review: "I always felt my lower face looked heavy in photos. It sits flatter now and the jaw has a cleaner line to it." },
    { before: "/assets/treatments/fat-dissolving-malta-ba3-1.jpg", after: "/assets/treatments/fat-dissolving-malta-ba3-2.jpg", label: "Chin and jaw contour", name: "Roberta F.", review: "There was a bit of fullness round my chin that filler never fixed. This sorted it, and my side profile is a lot sharper." },
    { before: "/assets/treatments/fat-dissolving-malta-ba4-1.jpg", after: "/assets/treatments/fat-dissolving-malta-ba4-2.jpg", label: "Cheek and mid-face fat", name: "Daniela M.", review: "My cheeks were rounder than I liked. They look a touch slimmer now and my cheekbone shows through more. Glad I did it." },
    { before: "/assets/treatments/fat-dissolving-malta-ba5-1.jpg", after: "/assets/treatments/fat-dissolving-malta-ba5-2.jpg", label: "Jowl and jawline fat", name: "Christine A.", review: "The little pocket near my jowl had been there for ages. It has softened off nicely and the jaw looks tighter side on." },
    { before: "/assets/treatments/fat-dissolving-malta-ba6-1.jpg", after: "/assets/treatments/fat-dissolving-malta-ba6-2.jpg", label: "Full cheeks and jaw", name: "Nadia P.", review: "Honestly wasn't sure it would do much, but my cheeks are less puffy and the whole face reads more defined now." },
    { before: "/assets/treatments/fat-dissolving-malta-ba7-1.jpg", after: "/assets/treatments/fat-dissolving-malta-ba7-2.jpg", label: "Under-chin and jaw fat", name: "Julia S.", review: "It's a small change but it makes a difference. The area under my chin is flatter and my jaw looks more clearly drawn." },
    { before: "/assets/treatments/fat-dissolving-malta-ba8-1.jpg", after: "/assets/treatments/fat-dissolving-malta-ba8-2.jpg", label: "Lower-face jowl fat", name: "Roberta V.", review: "I had noticed my lower face starting to go heavy. A couple of sessions later it sits much neater along the jaw." },
    { before: "/assets/treatments/fat-dissolving-malta-ba9-1.jpg", after: "/assets/treatments/fat-dissolving-malta-ba9-2.jpg", label: "Double chin fat", name: "Anna L.", review: "The double chin was the thing I hated in every photo. It has come right down and my neckline looks so much longer." },
    { before: "/assets/treatments/fat-dissolving-malta-ba10-1.jpg", after: "/assets/treatments/fat-dissolving-malta-ba10-2.jpg", label: "Lower-face fullness", name: "Suzanne G.", review: "My lower face had filled out over the years. The fullness has eased and my jaw reads more defined side on. Pleased with it." },
  ],
  precision: {
