...
const t: Treatment = {
  ...
  info: [
    ...
    { metric: "Results Last For", detail: "Long-lasting" },
    { metric: "Results Visible In", detail: "2-4 Weeks" },
    { metric: "Anaesthetic", detail: "None" },
  ],
  beforeAfterTitle: "YOUR JAWLINE, REDEFINED",
  beforeAfter: [
    { before: "/assets/treatments/snatch-your-jawline-ba1-1.jpg", after: "/assets/treatments/snatch-your-jawline-ba1-2.jpg", label: "Jawline and chin definition", name: "Maria C.", review: "My jaw used to just melt into my neck. Now there is a proper line when I turn my head, and photos look so much better." },
    { before: "/assets/treatments/snatch-your-jawline-ba2-2.jpg", after: "/assets/treatments/snatch-your-jawline-ba2-1.jpg", label: "Chin and jaw contour", name: "Elena B.", review: "From the side my chin always looked a bit pushed back. It sits more forward now and the whole lower face feels balanced." },
    { before: "/assets/treatments/snatch-your-jawline-ba3-1.jpg", after: "/assets/treatments/snatch-your-jawline-ba3-2.jpg", label: "Chin projection and jawline", name: "Roberta F.", review: "I wanted a sharper profile and that is roughly what I got. The chin looks stronger and nothing about it reads as overdone." },
    { before: "/assets/treatments/snatch-your-jawline-ba4-1.jpg", after: "/assets/treatments/snatch-your-jawline-ba4-2.jpg", label: "Jawline and under-chin", name: "Daniela M.", review: "There was always a softness under my jaw that bugged me. It looks tighter now, especially when I tip my head back for a photo." },
    { before: "/assets/treatments/snatch-your-jawline-ba5-1.jpg", after: "/assets/treatments/snatch-your-jawline-ba5-2.jpg", label: "Lower jaw definition", name: "Nadia S.", review: "Honestly the change is on the subtle side, but it is there. My jaw reads cleaner and I notice it most in selfies from below." },
    { before: "/assets/treatments/snatch-your-jawline-ba6-2.jpg", after: "/assets/treatments/snatch-your-jawline-ba6-1.jpg", label: "Jawline and chin contour", name: "Christine A.", review: "The redness settled after a couple of days and the line along my jaw is much crisper now. Glad I went ahead with it." },
    { before: "/assets/treatments/snatch-your-jawline-ba7-2.jpg", after: "/assets/treatments/snatch-your-jawline-ba7-1.jpg", label: "Chin and jaw definition", name: "Julia P.", review: "My side profile always felt a bit flat to me. The chin comes forward more now and the jaw looks lifted, which is what I wanted." },
    { before: "/assets/treatments/snatch-your-jawline-ba8-1.jpg", after: "/assets/treatments/snatch-your-jawline-ba8-2.jpg", label: "Jaw and under-chin", name: "Lara V.", review: "The area under my chin felt heavy before. It looks tighter now and the jaw has a real edge to it when I look up." },
    { before: "/assets/treatments/snatch-your-jawline-ba9-1.jpg", after: "/assets/treatments/snatch-your-jawline-ba9-2.jpg", label: "Jawline definition", name: "Stephanie G.", review: "I can actually see my jawline now. It used to sort of vanish into my neck, and the change makes my whole face look a touch slimmer." },
    { before: "/assets/treatments/snatch-your-jawline-ba10-1.jpg", after: "/assets/treatments/snatch-your-jawline-ba10-2.jpg", label: "Lower face and jaw contour", name: "Antonella Z.", review: "My lower face always felt a little heavy. The jaw looks more sculpted and lifted now, and it healed faster than I expected." },
  ],
  problem: {
  ...
  guarantee: {
    ...
    paragraphs: [
      "Every jawline plan starts with a doctor-led facial assessment and a natural-first approach that is never overdone, backed by a free follow-up review until you are 100% satisfied with a result that still looks like you.",
    ],
    cta: "Book Your Free Consultation",
    points: [
      { value: "Doctor-led", label: "Assessment first", sub: "Never a salesperson" },
      { value: "Natural-first", label: "Defined, never over-sculpted", sub: "We refine your profile, never distort it" },
  ...
  precision: {
    ...
    areas: [
      ...
      { name: "Skin Firmness", desc: "Tightens and smooths to reduce sagging and restore a lifted look." },
      { name: "Neck Transition", desc: "Cleans up the chin-to-neck angle for a more elegant side profile." },
    ],
  },
  suitability: {
    ...
    personas: [
      ...
      { title: "The undefined jawline", desc: "Your jawline has lost its sharp edge and you want it back without surgery or downtime." },
      { title: "The photo-conscious", desc: "You notice it most in side-on photos and on camera, and you want a cleaner, more defined angle." },
    ],
  },
  experience: {
  ...
  trusted: {
    ...
    images: [
      ...
      "/assets/treatments/fat-dissolving-malta-trusted3.jpg",
  ...
  planSummary: {
    ...
    included: [
      ...
      { label: "Personalised jawline-sculpting plan" },
      { label: "Fat-dissolving & contouring treatment", value: "from €149" },
      { label: "Complimentary results review" },
      { label: "Aftercare guidance & ongoing support" },
    ],
    price: "From €149",
    priceLabel: "per session",
    cta: { text: "Book Your Jawline Consultation", href: "/consultation" },
    reviews: "200+ verified reviews",
  },
  recommended: {
    title: "Recommended with Snatch Your Jawline",
    items: [
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Most patients find it very tolerable. The injections are performed using a fine needle, and the sensation is often described as a brief pinch or mild pressure. To keep you comfortable, a topical numbing cream can be applied beforehand if needed. Our doctors guide you through each step with care and precision.",
    },
    {
      q: "How long is the recovery and downtime?",
      a: "Downtime is minimal. You may experience some swelling, tenderness, or mild bruising under the chin for a few days, which is completely normal as the area responds to treatment. Most people return to their normal activities straight away. Your doctor will provide simple aftercare guidance to help your result settle beautifully.",
    },
    {
    ...
    },
    {
      ...
      a: "Once the treated fat cells are cleared, they cannot store or accumulate fat again. As long as you maintain a stable weight, your sculpted jawline results are designed to be long-lasting. Some patients choose a light maintenance plan over time to keep their profile looking its sharpest.",
    },
    {
    ...
    },
    {
      ...
      a: "This package is ideal for people with minimal to moderate localised fat under the chin or along the jawline who want a more defined profile without surgery. It may not be suitable if you have significant skin laxity or are looking for overall weight loss. A thorough consultation with one of our doctors is the best way to confirm it is right for you and to design your personalised plan.",
    },
    {
      q: "How much does the Snatch Your Jawline package cost in Malta?",
      a: "The jawline sculpting package at Carisma starts from €149 per session. The exact plan and number of sessions depend on the amount of fat being treated and the definition you are aiming for. Book a free consultation at our St. Julian's clinic for a personalised assessment and quote.",
    },
  ],
};
