...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/hair-regrowth-ba1-1.jpg", after: "/assets/treatments/hair-regrowth-ba1-2.jpg", label: "Thinning temples", name: "Maria C.", review: "That bare patch near my temple used to show every time I tied my hair up. It has filled in nicely and I worry about it far less now." },
    { before: "/assets/treatments/hair-regrowth-ba2-1.jpg", after: "/assets/treatments/hair-regrowth-ba2-2.jpg", label: "Receding front hairline", name: "Mark B.", review: "My hairline had crept back and the top looked thin. A few months on, there is real coverage again, sitting much closer to my forehead." },
    { before: "/assets/treatments/hair-regrowth-ba3-1.jpg", after: "/assets/treatments/hair-regrowth-ba3-2.jpg", label: "Thinning crown", name: "Joseph A.", review: "You could see straight through to my scalp at the back. It looks a lot thicker now and I am not so fussed about photos from behind." },
    { before: "/assets/treatments/hair-regrowth-ba4-1.jpg", after: "/assets/treatments/hair-regrowth-ba4-2.jpg", label: "Thinning front hairline", name: "Luca P.", review: "The front had gone so sparse you could see skin through it. It sits fuller now and the line runs more even across." },
    { before: "/assets/treatments/hair-regrowth-ba5-1.jpg", after: "/assets/treatments/hair-regrowth-ba5-2.jpg", label: "Frontal hair loss", name: "Steve M.", review: "Honestly I had nearly given up on the front. There is proper hair coming through now, not just fuzz, and it suits my face." },
    { before: "/assets/treatments/hair-regrowth-ba6-1.jpg", after: "/assets/treatments/hair-regrowth-ba6-2.jpg", label: "Diffuse thinning on top", name: "Julian S.", review: "The whole top had gone patchy and pale. It has come in denser and more even, and even my barber noticed the difference." },
    { before: "/assets/treatments/hair-regrowth-ba7-1.jpg", after: "/assets/treatments/hair-regrowth-ba7-2.jpg", label: "Widening centre parting", name: "Elena V.", review: "My parting kept getting wider with the scalp showing through. It looks much tighter now and I can part it without that gap." },
    { before: "/assets/treatments/hair-regrowth-ba8-1.jpg", after: "/assets/treatments/hair-regrowth-ba8-2.jpg", label: "Crown bald spot", name: "Daniel F.", review: "There was a clear bald circle at my crown that my wife always pointed out. It has filled in and you can barely find it now." },
    { before: "/assets/treatments/hair-regrowth-ba9-1.jpg", after: "/assets/treatments/hair-regrowth-ba9-2.jpg", label: "Thinning crown whorl", name: "Christian G.", review: "The hair around my crown swirl had thinned right out. After the sessions it is noticeably thicker and the scalp no longer catches the light." },
    { before: "/assets/treatments/hair-regrowth-ba10-1.jpg", after: "/assets/treatments/hair-regrowth-ba10-2.jpg", label: "Crown thinning", name: "Daniela E.", review: "The back of my head had gone thin and it really bothered me in updos. It feels fuller now and I am happy with how it has come back." },
  ],
  problem: {
