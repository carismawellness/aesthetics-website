...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba1-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba1-2.jpg", label: "Crow's feet and crepiness", name: "Maria C.", review: "My outer eye area used to look so crinkled when I smiled. It sits softer now and the skin feels much less papery." },
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba2-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba2-2.jpg", label: "Under-eye hollows and dullness", name: "Roberta B.", review: "The shadows under my eyes were the thing I always noticed. After a few sessions the area looks brighter and a bit fuller." },
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba3-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba3-2.jpg", label: "Side crow's feet lines", name: "Mark A.", review: "Those deep lines on the side of my eye used to fold right up. They look a lot smoother now, even when I squint a bit." },
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba4-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba4-2.jpg", label: "Crow's feet and laxity", name: "Julian F.", review: "Skin around my eye felt loose and lined. It reads firmer now and the little creases have calmed down a good amount." },
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba5-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba5-2.jpg", label: "Crepey under-eye skin", name: "Steve V.", review: "The skin under my eye was dry and crinkly. Now it looks more hydrated and the fine lines there are softer than before." },
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba6-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba6-2.jpg", label: "Tear trough and dark circles", name: "Daniela G.", review: "I had a real shadow in the tear trough. It looks lifted and brighter now, and I am not reaching for as much concealer." },
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba7-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba7-2.jpg", label: "Pores and skin texture", name: "Elena P.", review: "My pores around the nose were really obvious. The skin looks finer and smoother now, especially in good light." },
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba8-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba8-2.jpg", label: "Under-eye fine lines", name: "Nadia S.", review: "The crepey lines under my eye used to bother me. They are softer now and the whole area looks a little fresher." },
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba9-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba9-2.jpg", label: "Open pores and texture", name: "Christine M.", review: "Texture on my cheek was uneven and a bit dull. It feels smoother to touch now and looks more even overall." },
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba10-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba10-2.jpg", label: "Cheek dullness and texture", name: "Luisa Z.", review: "My cheeks looked a bit tired and blotchy before. The tone is more even now and the skin has a healthier glow to it." },
  ],
  precision: {
