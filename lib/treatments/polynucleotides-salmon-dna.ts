...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba1-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba1-2.jpg", label: "Crow's feet and crepiness", name: "Maria C.", review: "When I smiled my outer eye creased right up. It sits softer now and the cheek feels less papery to touch." },
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba2-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba2-2.jpg", label: "Under-eye shadows", name: "Roberta B.", review: "The darkness under my eyes was always the first thing I saw in photos. A few sessions in and it looks brighter, a bit fuller too." },
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba3-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba3-2.jpg", label: "Deep crow's feet", name: "Mark A.", review: "The lines at the side of my eye used to fold into deep creases. They read much smoother now, even when I squint." },
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba4-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba4-2.jpg", label: "Crow's feet and laxity", name: "Julian F.", review: "Skin around the eye felt loose and lined. It looks firmer now and the little creases have settled down a good bit." },
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba5-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba5-2.jpg", label: "Crepey under-eye skin", name: "Daniela G.", review: "Under my eye was dry and crinkly and a little puffy. Now it looks more hydrated and the fine lines have eased." },
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba6-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba6-2.jpg", label: "Crow's feet and crepiness", name: "Steve V.", review: "My laugh lines ran halfway down the cheek and looked etched in. They sit a lot softer now, less like deep grooves." },
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba7-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba7-2.jpg", label: "Pores and skin texture", name: "Elena P.", review: "My pores near the nose were really open and the skin felt rough. It looks finer and smoother now, especially in daylight." },
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba8-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba8-2.jpg", label: "Crepey under-eye lines", name: "Luca M.", review: "The skin under my eye was shiny and lined with little creases. It feels smoother now and the lines are less obvious." },
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba9-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba9-2.jpg", label: "Open pores and texture", name: "Christine M.", review: "Texture across my cheek was uneven and the pores stood out. It feels smoother to touch and looks more even overall." },
    { before: "/assets/treatments/polynucleotides-salmon-dna-ba10-1.jpg", after: "/assets/treatments/polynucleotides-salmon-dna-ba10-2.jpg", label: "Under-eye lines and texture", name: "Nadia S.", review: "I had little crepey lines under my eye and the cheek looked tired. The tone is more even now and the skin feels fresher." },
  ],
  precision: {
