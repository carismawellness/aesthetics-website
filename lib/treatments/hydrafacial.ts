...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/hydrafacial-ba1-1.jpg", after: "/assets/treatments/hydrafacial-ba6-1.jpg", label: "Brighter, clearer skin", name: "Elena V.", review: "The little bumps on my forehead settled and my skin reads brighter and more even. It feels properly hydrated, not tight." },
    { before: "/assets/treatments/hydrafacial-ba1-2.jpg", after: "/assets/treatments/hydrafacial-ba6-2.jpg", label: "Smoother cheek texture", name: "Rita C.", review: "The rough, bumpy patch on my cheek has calmed and the marks look fainter. When I run my hand over it the surface feels smooth now." },
    { before: "/assets/treatments/hydrafacial-ba3-2.jpg", after: "/assets/treatments/hydrafacial-ba8-2.jpg", label: "Calmer, even tone", name: "Marija G.", review: "The flushing across my nose and cheeks has eased and my tone looks much more even. My makeup sits better on top now." },
    { before: "/assets/treatments/hydrafacial-ba2-2.jpg", after: "/assets/treatments/hydrafacial-ba7-2.jpg", label: "Hydration and even tone", name: "Hannah B.", review: "The redness along my cheek has quietened and the skin looks dewy rather than dry. The small rough spots near my nose are gone." },
    { before: "/assets/treatments/hydrafacial-ba4-2.jpg", after: "/assets/treatments/hydrafacial-ba9-2.jpg", label: "Refined pores", name: "Karen S.", review: "The open pores on my cheek look noticeably tighter and the tiny bumps have cleared. The skin sits a lot smoother under the eye." },
    { before: "/assets/treatments/hydrafacial-ba10-1.jpg", after: "/assets/treatments/hydrafacial-ba10-2.jpg", label: "Settled, clearer skin", name: "Sophie R.", review: "The blotchy redness on my cheek has died down and a couple of spots have cleared. My skin looks calm and a bit more polished." },
