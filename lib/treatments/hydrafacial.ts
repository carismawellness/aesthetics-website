...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/hydrafacial-ba1-2.jpg", after: "/assets/treatments/hydrafacial-ba1-1.jpg", label: "Congestion and rough texture", name: "Maria B.", review: "My cheeks always felt bumpy under makeup. A few sessions in and the skin sits smoother, and the clogged little bits have eased off." },
    { before: "/assets/treatments/hydrafacial-ba2-1.jpg", after: "/assets/treatments/hydrafacial-ba2-2.jpg", label: "Redness and uneven tone", name: "Elena C.", review: "The redness across my cheeks used to bug me. It reads a lot more even now and the surface feels properly clean rather than congested." },
    { before: "/assets/treatments/hydrafacial-ba3-1.jpg", after: "/assets/treatments/hydrafacial-ba3-2.jpg", label: "Dull, uneven skin tone", name: "Roberta M.", review: "Booked it before a wedding. My skin looked brighter and a touch more even after, and it felt fresh rather than stripped." },
    { before: "/assets/treatments/hydrafacial-ba4-2.jpg", after: "/assets/treatments/hydrafacial-ba4-1.jpg", label: "Enlarged pores on cheek", name: "Daniela F.", review: "The pores on my cheek were quite obvious before. They look smaller and cleaner now, and my skin actually feels clear for once." },
    { before: "/assets/treatments/hydrafacial-ba5-2.jpg", after: "/assets/treatments/hydrafacial-ba5-1.jpg", label: "Redness and blemishes", name: "Nadia S.", review: "Came in with redness and a couple of breakouts. Weeks on, the skin is calmer and the blotchy patches have mostly gone." },
    { before: "/assets/treatments/hydrafacial-ba6-2.jpg", after: "/assets/treatments/hydrafacial-ba6-1.jpg", label: "Congestion and dullness", name: "Christine V.", review: "Wasn't sure what to expect, but my skin looks brighter and feels deeply cleaned. The small bumps along my jaw have settled too." },
    { before: "/assets/treatments/hydrafacial-ba7-1.jpg", after: "/assets/treatments/hydrafacial-ba7-2.jpg", label: "Texture and redness", name: "Sofia A.", review: "The rough patches near my nose are softer now and the slight redness has toned down. Looks a bit clearer in photos as well." },
    { before: "/assets/treatments/hydrafacial-ba8-2.jpg", after: "/assets/treatments/hydrafacial-ba8-1.jpg", label: "Facial redness and tone", name: "Julia P.", review: "My face used to flush and go blotchy. Afterwards it looks far more even, and the glow stuck around longer than I expected." },
    { before: "/assets/treatments/hydrafacial-ba9-2.jpg", after: "/assets/treatments/hydrafacial-ba9-1.jpg", label: "Pores and dullness on cheek", name: "Rachel G.", review: "My cheeks looked tired and the pores stood out. The skin feels fresher now and the texture is noticeably finer to the touch." },
    { before: "/assets/treatments/hydrafacial-ba10-2.jpg", after: "/assets/treatments/hydrafacial-ba10-1.jpg", label: "Cheek redness and blemishes", name: "Lara D.", review: "Had redness and a few small spots along my cheek and chin. They've quietened down and the skin looks clearer and more even." },
  ],
  precision: {
