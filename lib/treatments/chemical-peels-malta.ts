...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/chemical-peels-malta-ba1-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba1-2.jpg", label: "Inflamed acne", name: "Martina C.", review: "The raised, sore spots across my cheek have settled right down and the skin there feels calm again." },
    { before: "/assets/treatments/chemical-peels-malta-ba2-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba2-2.jpg", label: "Acne and redness", name: "Elena P.", review: "My cheek used to flush red and stay bumpy. The redness has eased off and the spots are far fewer." },
    { before: "/assets/treatments/chemical-peels-malta-ba3-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba3-2.jpg", label: "Freckles and sun spots", name: "Rachel D.", review: "The dense freckling across my forehead and cheeks has softened and my skin tone reads much more even." },
    { before: "/assets/treatments/chemical-peels-malta-ba4-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba4-2.jpg", label: "Fine lines and texture", name: "Sophie M.", review: "The little creases around the corner of my mouth have smoothed and the skin sits firmer than before." },
    { before: "/assets/treatments/chemical-peels-malta-ba5-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba5-2.jpg", label: "Eye area pigmentation", name: "Joanna B.", review: "The brown patches by my eye and temple have lightened and that side of my face looks clearer now." },
    { before: "/assets/treatments/chemical-peels-malta-ba6-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba6-2.jpg", label: "Facial melasma", name: "Nadia F.", review: "The dark patches over my nose and cheeks have lifted and my whole face looks brighter in photos." },
    { before: "/assets/treatments/chemical-peels-malta-ba7-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba7-2.jpg", label: "Cheek melasma", name: "Carmen V.", review: "The large brown patch on the side of my face has faded right back and the tone is much steadier." },
    { before: "/assets/treatments/chemical-peels-malta-ba8-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba8-2.jpg", label: "Cheek melasma", name: "Isabel R.", review: "The discolouration on my cheek that I had hidden for years is so much fainter and the skin looks fresher." },
    { before: "/assets/treatments/chemical-peels-malta-ba9-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba9-2.jpg", label: "Sun spots", name: "Helen T.", review: "The darker spots across my cheek have faded and my skin looks more even when I catch it in daylight." },
    { before: "/assets/treatments/chemical-peels-malta-ba10-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba10-2.jpg", label: "Pigmentation and dullness", name: "Laura S.", review: "My skin looked dull with scattered marks. It reads brighter now and the spots have quietly softened." },
  ],
  precision: {
