...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/chemical-peels-malta-ba1-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba1-2.jpg", label: "Active acne and breakouts", name: "Daniela B.", review: "My cheek was covered in angry breakouts and a couple of painful cysts. After the course it has calmed right down and feels smoother." },
    { before: "/assets/treatments/chemical-peels-malta-ba2-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba2-2.jpg", label: "Acne and red marks", name: "Roberta C.", review: "The little spots and red marks on my cheek used to really get me down. They have faded a lot and the skin looks much more even." },
    { before: "/assets/treatments/chemical-peels-malta-ba3-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba3-2.jpg", label: "Freckling and sun spots", name: "Christine A.", review: "Years in the Malta sun left heavy freckling across my forehead and cheeks. It has lightened nicely and my tone looks more even now." },
    { before: "/assets/treatments/chemical-peels-malta-ba4-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba4-2.jpg", label: "Fine lines around the mouth", name: "Maria F.", review: "The little creases around my mouth have softened and the skin feels smoother when I touch it. Pleased with how natural it looks." },
    { before: "/assets/treatments/chemical-peels-malta-ba5-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba5-2.jpg", label: "Cheek sun spots", name: "Nadia P.", review: "I had a lot of brown speckling and a few darker spots on my cheek. They have lightened and the area looks fresher and clearer." },
    { before: "/assets/treatments/chemical-peels-malta-ba6-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba6-2.jpg", label: "Melasma across the face", name: "Stephanie M.", review: "My melasma had spread across most of my face and it really knocked my confidence. After a few sessions it is so much lighter." },
    { before: "/assets/treatments/chemical-peels-malta-ba7-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba7-2.jpg", label: "Melasma on the cheek", name: "Elena V.", review: "The dark patch on my cheek was quite deep. It has faded a good bit and the skin around it looks far more even than before." },
    { before: "/assets/treatments/chemical-peels-malta-ba8-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba8-2.jpg", label: "Cheek pigmentation", name: "Carmen G.", review: "I had a stubborn brown patch on one cheek for years. After the peels it has cleared up well and you can barely see it now." },
    { before: "/assets/treatments/chemical-peels-malta-ba9-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba9-2.jpg", label: "Age spots on the cheek", name: "Antoinette S.", review: "The brown age spots on my cheek kept getting darker every summer. They have softened a lot and the skin looks brighter." },
    { before: "/assets/treatments/chemical-peels-malta-ba10-1.jpg", after: "/assets/treatments/chemical-peels-malta-ba10-2.jpg", label: "Sun spots and uneven tone", name: "Julia R.", review: "My cheeks had patchy sun spots and looked a bit tired. The tone is clearer now and overall my skin just looks healthier." },
  ],
  precision: {
