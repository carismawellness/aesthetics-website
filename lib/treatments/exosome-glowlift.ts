...
const t: Treatment = {
  ...
  category: "Package",
  hero: {
    title: "Exosome GlowLift Package Malta — Firmer, Brighter Skin",
  ...
  experience: {
    title: "How the Exosome GlowLift Package Works — Your Journey",
    steps: [
      {
        title: "Step 1 — Before Your Session",
      ...
      {
        title: "Step 2 — Your GlowLift Session",
      ...
      {
        title: "Step 3 — Aftercare and Recovery",
  ...
  trusted: {
    title: "Medically Qualified Practitioners — Safe GlowLift in Malta",
  ...
  faqTitle: "Frequently Asked Questions About the Exosome GlowLift Package",
  faq: [
    {
      q: "What Is the Exosome GlowLift Package and How Does It Work?",
    ...
    {
      q: "How Much Does the Exosome GlowLift Package Cost in Malta?",
    ...
    {
      q: "Is the Exosome GlowLift Treatment Painful?",
    ...
    {
      q: "How Many Sessions Will I Need for Best Results?",
    ...
    {
      q: "What Is the Difference Between Exosomes and Mesotherapy?",
    ...
    {
      q: "What Is the Recovery Time After the GlowLift Package?",
    ...
    {
      q: "Can the Exosome GlowLift Help With Acne Scars?",
    ...
    {
      q: "What Are Exosomes and Why Are They Used in This Package?",
    ...
    {
      q: "Who Is Not Suitable for the Exosome GlowLift Package?",
    ...
    {
      q: "How Long Do Exosome GlowLift Results Last?",
