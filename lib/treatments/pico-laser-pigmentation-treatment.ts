...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/pico-laser-pigmentation-treatment-ba1-1.jpg", after: "/assets/treatments/pico-laser-pigmentation-treatment-ba1-2.jpg", label: "Cheek sun spots", name: "Maria C.", review: "The brown patches under my eye and across my cheek had been there for years. They have faded a lot and my skin looks much more even." },
    { before: "/assets/treatments/pico-laser-pigmentation-treatment-ba2-1.jpg", after: "/assets/treatments/pico-laser-pigmentation-treatment-ba2-2.jpg", label: "Upper back spots", name: "Roberta F.", review: "My back was dotted with little brown marks from years in the sun. Most have lifted, so I felt fine in a backless dress this summer." },
    { before: "/assets/treatments/pico-laser-pigmentation-treatment-ba3-1.jpg", after: "/assets/treatments/pico-laser-pigmentation-treatment-ba3-2.jpg", label: "Cheek melasma", name: "Christine B.", review: "That big dark patch on my cheek used to be the first thing I saw in the mirror. It has lightened so much now." },
    { before: "/assets/treatments/pico-laser-pigmentation-treatment-ba4-1.jpg", after: "/assets/treatments/pico-laser-pigmentation-treatment-ba4-2.jpg", label: "Facial sun spots", name: "Daniela M.", review: "Years of sun left freckly marks down the side of my face. The tone reads a lot calmer now and I feel okay going without makeup." },
    { before: "/assets/treatments/pico-laser-pigmentation-treatment-ba5-1.jpg", after: "/assets/treatments/pico-laser-pigmentation-treatment-ba5-2.jpg", label: "Cheek pigmentation", name: "Nadia P.", review: "My cheek had this mottled brown look that foundation never fully covered. After my sessions the skin is clearer and so much more even." },
    { before: "/assets/treatments/pico-laser-pigmentation-treatment-ba6-1.jpg", after: "/assets/treatments/pico-laser-pigmentation-treatment-ba6-2.jpg", label: "Forearm sun spots", name: "Sandra G.", review: "The little brown spots on my arm have faded nicely. I do not feel the need to keep my sleeves down at work anymore." },
    { before: "/assets/treatments/pico-laser-pigmentation-treatment-ba7-1.jpg", after: "/assets/treatments/pico-laser-pigmentation-treatment-ba7-2.jpg", label: "Neck pigmentation", name: "Elena V.", review: "The brown shading along my neck always bothered me in photos. It has settled down a lot and the skin looks fresher now." },
    { before: "/assets/treatments/pico-laser-pigmentation-treatment-ba8-1.jpg", after: "/assets/treatments/pico-laser-pigmentation-treatment-ba8-2.jpg", label: "Hand age spots", name: "Carmen Z.", review: "My hands looked older than I felt because of all the dark spots. They have really lightened and the tone is much more even." },
    { before: "/assets/treatments/pico-laser-pigmentation-treatment-ba9-1.jpg", after: "/assets/treatments/pico-laser-pigmentation-treatment-ba9-2.jpg", label: "Leg pigmentation", name: "Antonella S.", review: "My leg had loads of little dark spots scattered all over it. After the sessions it looks clearer and smoother in tone." },
    { before: "/assets/treatments/pico-laser-pigmentation-treatment-ba10-1.jpg", after: "/assets/treatments/pico-laser-pigmentation-treatment-ba10-2.jpg", label: "Cheek freckling", name: "Stephanie R.", review: "I had heavy freckling all over my cheek. The tone is so much more even now, and the under-eye area looks a bit fresher too." },
  ],
  problem: {
