...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/lip-fillers-malta-ba1-1.jpg", after: "/assets/treatments/lip-fillers-malta-ba1-2.jpg", label: "Lip volume and shape", name: "Maria C.", review: "My top lip was always so flat. Now it has a soft fullness that still looks like me, just a bit more balanced." },
    { before: "/assets/treatments/lip-fillers-malta-ba2-1.jpg", after: "/assets/treatments/lip-fillers-malta-ba2-2.jpg", label: "Lip definition and fullness", name: "Elena B.", review: "Booked this before my sister's wedding. The shape came up really nicely and the swelling had settled in a few days." },
    { before: "/assets/treatments/lip-fillers-malta-ba3-1.jpg", after: "/assets/treatments/lip-fillers-malta-ba3-2.jpg", label: "Lip projection and volume", name: "Roberta M.", review: "I wanted a bit more body without going huge, and that is what I got. My lips actually have some pout now." },
    { before: "/assets/treatments/lip-fillers-malta-ba4-1.jpg", after: "/assets/treatments/lip-fillers-malta-ba4-2.jpg", label: "Lip volume", name: "Daniela P.", review: "I was so nervous beforehand but it was quick and the result looks really natural. A little tender the first day, nothing bad." },
    { before: "/assets/treatments/lip-fillers-malta-ba5-1.jpg", after: "/assets/treatments/lip-fillers-malta-ba5-2.jpg", label: "Lip shape and balance", name: "Nadia F.", review: "One side was always a touch smaller than the other. They sit much more even now and the colour looks lovely too." },
    { before: "/assets/treatments/lip-fillers-malta-ba6-1.jpg", after: "/assets/treatments/lip-fillers-malta-ba6-2.jpg", label: "Lip fullness", name: "Christine V.", review: "Quite subtle but you can tell. They feel softer and a little fuller, which is what I was after. Really pleased." },
    { before: "/assets/treatments/lip-fillers-malta-ba7-1.jpg", after: "/assets/treatments/lip-fillers-malta-ba7-2.jpg", label: "Lip volume and contour", name: "Stephanie A.", review: "The outline around my mouth looks so much neater now. It took a few days to settle but I think it was worth the wait." },
    { before: "/assets/treatments/lip-fillers-malta-ba8-1.jpg", after: "/assets/treatments/lip-fillers-malta-ba8-2.jpg", label: "Lip volume and shape", name: "Gabriella P.", review: "I only wanted a little more shape and that is exactly what happened. Comfy through the whole thing and back to normal fast." },
    { before: "/assets/treatments/lip-fillers-malta-ba9-1.jpg", after: "/assets/treatments/lip-fillers-malta-ba9-2.jpg", label: "Lip volume and balance", name: "Annalise S.", review: "I was worried it would look done. It really doesn't. Just a softer, slightly fuller version of my own lips." },
    { before: "/assets/treatments/lip-fillers-malta-ba10-1.jpg", after: "/assets/treatments/lip-fillers-malta-ba10-2.jpg", label: "Lip fullness and definition", name: "Rebecca T.", review: "Such a difference in the photos. My lips look plumper and the edges are crisper. A tiny mark went down within a day." },
  ],
  problem: {
