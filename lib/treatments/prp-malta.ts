...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/prp-malta-ba1-1.jpg", after: "/assets/treatments/prp-malta-ba1-2.jpg", label: "Under-eye fine lines", name: "Roberta M.", review: "The skin under my eyes had gone thin and crepey, and it always showed in photos. A few sessions in it sits smoother and looks a bit fresher." },
    { before: "/assets/treatments/prp-malta-ba2-1.jpg", after: "/assets/treatments/prp-malta-ba2-2.jpg", label: "Crow's feet", name: "Elena B.", review: "Those little lines at the corner of my eye were the thing I kept catching. They have softened and the skin there feels firmer to me now." },
    { before: "/assets/treatments/prp-malta-ba3-2.jpg", after: "/assets/treatments/prp-malta-ba3-1.jpg", label: "Cheek pigmentation", name: "Daniela C.", review: "I came in about the brown patches on my cheek. They are lighter now and my tone reads more even than it has in a long time." },
    { before: "/assets/treatments/prp-malta-ba4-2.jpg", after: "/assets/treatments/prp-malta-ba4-1.jpg", label: "Redness and pores", name: "Christine F.", review: "My cheek was red and the pores really stood out up close. It looks calmer now and the surface is finer than I expected." },
    { before: "/assets/treatments/prp-malta-ba5-2.jpg", after: "/assets/treatments/prp-malta-ba5-1.jpg", label: "Acne scarring", name: "Marija A.", review: "I had deep scarring on my cheek from old breakouts. It is still there but shallower, and day to day the skin feels much smoother." },
    { before: "/assets/treatments/prp-malta-ba6-1.jpg", after: "/assets/treatments/prp-malta-ba6-2.jpg", label: "Redness and dull skin", name: "Nadia S.", review: "My face had gone flat and a little blotchy. Now there is some glow back, the redness has settled, and it feels plumper to touch." },
    { before: "/assets/treatments/prp-malta-ba7-1.jpg", after: "/assets/treatments/prp-malta-ba7-2.jpg", label: "Sun spots and fine lines", name: "Maria G.", review: "The sun spots across my cheek had been bugging me for ages. They have faded and the fine lines next to my eye look softer too." },
    { before: "/assets/treatments/prp-malta-ba8-2.jpg", after: "/assets/treatments/prp-malta-ba8-1.jpg", label: "Cheek melasma", name: "Claudia P.", review: "The patchy pigment on my cheek used to need a fair bit of makeup to hide. It has lifted a lot and my skin looks clearer bare faced." },
    { before: "/assets/treatments/prp-malta-ba9-2.jpg", after: "/assets/treatments/prp-malta-ba9-1.jpg", label: "Dull, congested skin", name: "Roberta V.", review: "My cheek looked tired and a bit congested. It has brightened up nicely and the pores are less obvious when I catch the light now." },
    { before: "/assets/treatments/prp-malta-ba10-2.jpg", after: "/assets/treatments/prp-malta-ba10-1.jpg", label: "Pigment marks and texture", name: "Stephanie D.", review: "There were old marks and rough patches on my cheek that never seemed to budge. The surface looks more even now, sooner than I thought it would." },
  ],
  precision: {
