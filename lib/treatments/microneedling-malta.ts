...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/microneedling-malta-ba1-1.jpg", after: "/assets/treatments/microneedling-malta-ba1-2.jpg", label: "Redness and tone", name: "Elena V.", review: "The flushed patches on my cheeks settled right down and the colour reads a lot more even across my face now." },
    { before: "/assets/treatments/microneedling-malta-ba2-2.jpg", after: "/assets/treatments/microneedling-malta-ba2-1.jpg", label: "Cheek texture", name: "Marta B.", review: "The little red bumps along my cheek and jaw calmed, and the surface feels noticeably smoother to the touch." },
    { before: "/assets/treatments/microneedling-malta-ba3-2.jpg", after: "/assets/treatments/microneedling-malta-ba3-1.jpg", label: "Central redness", name: "Claudia R.", review: "The redness around my nose and cheeks has eased off and my skin looks calmer in photos than it used to." },
    { before: "/assets/treatments/microneedling-malta-ba4-1.jpg", after: "/assets/treatments/microneedling-malta-ba4-2.jpg", label: "Rough texture", name: "Nadia S.", review: "The rough patch on the side of my face evened out, and the cheek looks brighter and clearer than before." },
    { before: "/assets/treatments/microneedling-malta-ba5-1.jpg", after: "/assets/treatments/microneedling-malta-ba5-2.jpg", label: "Chin and lip area", name: "Sofia M.", review: "Those tiny bumps around my chin and lip line smoothed over and the skin sits much more evenly now." },
    { before: "/assets/treatments/microneedling-malta-ba6-1.jpg", after: "/assets/treatments/microneedling-malta-ba6-2.jpg", label: "Sun spots", name: "Diana P.", review: "The brown sun spots scattered over my cheek have faded and they catch the light far less than they did." },
    { before: "/assets/treatments/microneedling-malta-ba7-1.jpg", after: "/assets/treatments/microneedling-malta-ba7-2.jpg", label: "Fine lines", name: "Helen T.", review: "The fine lines fanning out from my eye have softened and the skin underneath looks less crepey day to day." },
    { before: "/assets/treatments/microneedling-malta-ba8-2.jpg", after: "/assets/treatments/microneedling-malta-ba8-1.jpg", label: "Blotchy redness", name: "Rita G.", review: "My cheeks used to flush blotchy and uneven, and the tone across them looks far more settled in the mirror now." },
    { before: "/assets/treatments/microneedling-malta-ba9-1.jpg", after: "/assets/treatments/microneedling-malta-ba9-2.jpg", label: "Skin texture", name: "Lara C.", review: "The dull, uneven feel along my cheek has lifted and the skin looks fresher and more refined up close." },
    { before: "/assets/treatments/microneedling-malta-ba10-1.jpg", after: "/assets/treatments/microneedling-malta-ba10-2.jpg", label: "Pore refinement", name: "Anna F.", review: "The pores along my nose and under my eye look tighter, and that whole area is a lot less shiny than before." },
  ],
  precision: {
