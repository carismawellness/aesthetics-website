...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/microneedling-malta-ba1-1.jpg", after: "/assets/treatments/microneedling-malta-ba1-2.jpg", label: "Cheek redness and texture", name: "Maria C.", review: "My cheeks were red and blotchy with a few old marks. A few sessions in, the skin reads calmer and far more even." },
    { before: "/assets/treatments/microneedling-malta-ba2-1.jpg", after: "/assets/treatments/microneedling-malta-ba2-2.jpg", label: "Cheek texture and blemishes", name: "Roberta M.", review: "I had small spots and rough patches down the side of my face. They have settled and the cheek feels smoother to touch now." },
    { before: "/assets/treatments/microneedling-malta-ba3-2.jpg", after: "/assets/treatments/microneedling-malta-ba3-1.jpg", label: "Facial redness", name: "Elena B.", review: "The redness across my cheeks and nose used to flare so easily. It looks much more settled now and my makeup sits better." },
    { before: "/assets/treatments/microneedling-malta-ba4-1.jpg", after: "/assets/treatments/microneedling-malta-ba4-2.jpg", label: "Cheek texture and marks", name: "Daniela P.", review: "The side of my face had a rough surface and a couple of marks. Not totally gone, but it has smoothed out a fair bit." },
    { before: "/assets/treatments/microneedling-malta-ba5-1.jpg", after: "/assets/treatments/microneedling-malta-ba5-2.jpg", label: "Lower-face texture", name: "Christine A.", review: "My chin felt bumpy and little spots kept appearing. Things look clearer now and the skin has a nicer glow to it." },
    { before: "/assets/treatments/microneedling-malta-ba6-1.jpg", after: "/assets/treatments/microneedling-malta-ba6-2.jpg", label: "Cheek pigmentation", name: "Antoinette G.", review: "I had a fair bit of brown pigmentation along my cheek. The spots have faded a lot and the whole area looks fresher." },
    { before: "/assets/treatments/microneedling-malta-ba7-1.jpg", after: "/assets/treatments/microneedling-malta-ba7-2.jpg", label: "Lines around the eyes", name: "Rita V.", review: "The lines around my eye were getting quite deep and crepey. After the course they sit softer and the skin feels firmer there." },
    { before: "/assets/treatments/microneedling-malta-ba8-1.jpg", after: "/assets/treatments/microneedling-malta-ba8-2.jpg", label: "Blemish marks and tone", name: "Nadia F.", review: "A few marks on my cheeks and forehead had me a bit self conscious. They have faded and the tone looks more even overall." },
    { before: "/assets/treatments/microneedling-malta-ba9-1.jpg", after: "/assets/treatments/microneedling-malta-ba9-2.jpg", label: "Cheek texture and pores", name: "Julia S.", review: "My cheeks looked dull and the texture bothered me. The skin feels plumper now and the surface is noticeably smoother than before." },
    { before: "/assets/treatments/microneedling-malta-ba10-1.jpg", after: "/assets/treatments/microneedling-malta-ba10-2.jpg", label: "Enlarged pores on the nose", name: "Stephanie B.", review: "The pores along my nose were so obvious up close. They look tighter now and that part of my face is far less shiny." },
  ],
  precision: {
