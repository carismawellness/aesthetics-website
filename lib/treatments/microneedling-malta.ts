...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/microneedling-malta-ba1-1.jpg", after: "/assets/treatments/microneedling-malta-ba1-2.jpg", label: "Cheek redness and texture", name: "Maria C.", review: "My cheeks were red and a bit blotchy with some old marks. After the sessions the skin looks calmer and a lot more even." },
    { before: "/assets/treatments/microneedling-malta-ba2-1.jpg", after: "/assets/treatments/microneedling-malta-ba2-2.jpg", label: "Cheek texture and blemishes", name: "Roberta M.", review: "I had a few little spots and rough patches along my cheek. They have settled nicely and the skin feels softer to touch now." },
    { before: "/assets/treatments/microneedling-malta-ba3-2.jpg", after: "/assets/treatments/microneedling-malta-ba3-1.jpg", label: "Facial redness and tone", name: "Elena B.", review: "The redness across my cheeks and nose was the thing I hated in photos. It looks much more even now and my makeup goes on better." },
    { before: "/assets/treatments/microneedling-malta-ba4-1.jpg", after: "/assets/treatments/microneedling-malta-ba4-2.jpg", label: "Cheek texture and marks", name: "Daniela P.", review: "The side of my face had some marks and a rough surface. It is not gone completely but it has smoothed out a fair bit." },
    { before: "/assets/treatments/microneedling-malta-ba5-1.jpg", after: "/assets/treatments/microneedling-malta-ba5-2.jpg", label: "Lower-face texture", name: "Christine A.", review: "My chin area felt bumpy and a couple of spots kept popping up. Things look clearer now and the skin has a nicer glow to it." },
    { before: "/assets/treatments/microneedling-malta-ba6-1.jpg", after: "/assets/treatments/microneedling-malta-ba6-2.jpg", label: "Cheek pigmentation", name: "Antoinette G.", review: "I had a fair bit of pigmentation on my cheek and some fine lines creeping in. The marks have faded and the area looks fresher." },
    { before: "/assets/treatments/microneedling-malta-ba7-1.jpg", after: "/assets/treatments/microneedling-malta-ba7-2.jpg", label: "Fine lines around eyes", name: "Rita V.", review: "The lines around my eyes were getting deeper and the skin felt crepey. After the course they look softer and the surface is smoother." },
    { before: "/assets/treatments/microneedling-malta-ba8-1.jpg", after: "/assets/treatments/microneedling-malta-ba8-2.jpg", label: "Cheek redness and tone", name: "Nadia F.", review: "There was a patch of redness and a stubborn spot on my cheek. It took a bit of patience but the whole face reads more even now." },
    { before: "/assets/treatments/microneedling-malta-ba9-1.jpg", after: "/assets/treatments/microneedling-malta-ba9-2.jpg", label: "Cheek texture and pores", name: "Julia S.", review: "My cheeks looked a little dull and the pores bothered me. Now the skin feels plumper and the surface is noticeably smoother." },
    { before: "/assets/treatments/microneedling-malta-ba10-1.jpg", after: "/assets/treatments/microneedling-malta-ba10-2.jpg", label: "Nose and cheek pores", name: "Stephanie X.", review: "The pores along my nose were really obvious up close. They look tighter now and that part of my face is far less shiny." },
  ],
  precision: {
