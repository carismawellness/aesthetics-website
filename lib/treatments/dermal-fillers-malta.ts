...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/dermal-fillers-malta-ba1-1.jpg", after: "/assets/treatments/dermal-fillers-malta-ba1-2.jpg", label: "Chin profile", name: "Marija C.", review: "From the side my chin used to sit back quite far. It projects a little more now and my profile feels balanced." },
    { before: "/assets/treatments/dermal-fillers-malta-ba2-1.jpg", after: "/assets/treatments/dermal-fillers-malta-ba2-2.jpg", label: "Lip shape", name: "Elena P.", review: "My top and bottom lip were slightly mismatched before. They sit more evenly now and still feel like mine." },
    { before: "/assets/treatments/dermal-fillers-malta-ba3-1.jpg", after: "/assets/treatments/dermal-fillers-malta-ba3-2.jpg", label: "Under-eye hollows", name: "Sofia R.", review: "The dark hollows under my eyes used to make me look worn out. The area is smoother now and I photograph better." },
    { before: "/assets/treatments/dermal-fillers-malta-ba4-1.jpg", after: "/assets/treatments/dermal-fillers-malta-ba4-2.jpg", label: "Tear trough", name: "Hannah L.", review: "There was a deep shadow sitting right under my eye. It has filled in softly and the crease is far less obvious." },
    { before: "/assets/treatments/dermal-fillers-malta-ba5-1.jpg", after: "/assets/treatments/dermal-fillers-malta-ba5-2.jpg", label: "Lip volume", name: "Andrea S.", review: "My lips were on the thin side and a bit flat. They have gentle fullness now that suits the rest of my face." },
    { before: "/assets/treatments/dermal-fillers-malta-ba6-1.jpg", after: "/assets/treatments/dermal-fillers-malta-ba6-2.jpg", label: "Lip enhancement", name: "Klara B.", review: "I only wanted a small change and that is what I got. A touch more body in the lips, nothing obvious." },
    { before: "/assets/treatments/dermal-fillers-malta-ba7-1.jpg", after: "/assets/treatments/dermal-fillers-malta-ba7-2.jpg", label: "Lip definition", name: "Nina V.", review: "My lip edge had very little shape. The border reads more clearly now and the lower lip has a bit more body." },
    { before: "/assets/treatments/dermal-fillers-malta-ba8-1.jpg", after: "/assets/treatments/dermal-fillers-malta-ba8-2.jpg", label: "Smile line softening", name: "Carmen D.", review: "The lines from my nose down to my mouth were quite deep. They have softened and my face looks a little fresher." },
    { before: "/assets/treatments/dermal-fillers-malta-ba9-2.jpg", after: "/assets/treatments/dermal-fillers-malta-ba9-1.jpg", label: "Lip profile", name: "Roberta M.", review: "Seen from the side my lips were fairly flat. They have a softer curve now and the shape feels more put together." },
    { before: "/assets/treatments/dermal-fillers-malta-ba10-1.jpg", after: "/assets/treatments/dermal-fillers-malta-ba10-2.jpg", label: "Lip volume", name: "Julia T.", review: "My lips had almost no shape to them before. There is a gentle fullness now that looks right for my face." },
  ],
  problem: {
