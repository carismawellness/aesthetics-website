...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/dermal-fillers-malta-ba1-1.jpg", after: "/assets/treatments/dermal-fillers-malta-ba1-2.jpg", label: "Cheek and midface volume", name: "Maria C.", review: "From the side my cheek had gone a bit flat and tired looking. There is a soft lift to it now and my profile sits better." },
    { before: "/assets/treatments/dermal-fillers-malta-ba2-1.jpg", after: "/assets/treatments/dermal-fillers-malta-ba2-2.jpg", label: "Cheek and under-eye volume", name: "Chiara B.", review: "I had hollows under my eyes and my cheeks felt deflated. They look fuller and a bit more rested now, still very much me." },
    { before: "/assets/treatments/dermal-fillers-malta-ba3-1.jpg", after: "/assets/treatments/dermal-fillers-malta-ba3-2.jpg", label: "Lip and under-eye volume", name: "Elena V.", review: "My lips were on the thin side and the shadows under my eyes made me look worn out. Both look softer now and it suits me." },
    { before: "/assets/treatments/dermal-fillers-malta-ba4-1.jpg", after: "/assets/treatments/dermal-fillers-malta-ba4-2.jpg", label: "Tear trough correction", name: "Christine F.", review: "The hollow under my eye threw a shadow even in decent light. It reads much smoother now and nobody can tell I had anything done." },
    { before: "/assets/treatments/dermal-fillers-malta-ba5-1.jpg", after: "/assets/treatments/dermal-fillers-malta-ba5-2.jpg", label: "Lip and cheek volume", name: "Nadia G.", review: "I wanted a touch more on my lips and cheeks without looking obvious. It settled nicely and I just look a bit fresher." },
    { before: "/assets/treatments/dermal-fillers-malta-ba6-1.jpg", after: "/assets/treatments/dermal-fillers-malta-ba6-2.jpg", label: "Lip and cheek volume", name: "Roberta A.", review: "My lips had thinned and my cheeks felt a little sunken. There is gentle fullness to both now and my face looks more awake." },
    { before: "/assets/treatments/dermal-fillers-malta-ba7-1.jpg", after: "/assets/treatments/dermal-fillers-malta-ba7-2.jpg", label: "Lip volume and shape", name: "Sophie M.", review: "My lips were a bit thin and slightly uneven. They sit fuller now and the shape feels right, nothing overdone about it." },
    { before: "/assets/treatments/dermal-fillers-malta-ba8-1.jpg", after: "/assets/treatments/dermal-fillers-malta-ba8-2.jpg", label: "Midface volume restore", name: "Antonella S.", review: "My cheeks had dropped and the lines by my mouth had got deeper. Lifting the cheeks softened all of it and my face looks less heavy." },
    { before: "/assets/treatments/dermal-fillers-malta-ba9-1.jpg", after: "/assets/treatments/dermal-fillers-malta-ba9-2.jpg", label: "Lip and chin definition", name: "Daniela P.", review: "From the side my lips looked flat and my chin a little weak. There is more balance now and my profile feels properly in proportion." },
    { before: "/assets/treatments/dermal-fillers-malta-ba10-1.jpg", after: "/assets/treatments/dermal-fillers-malta-ba10-2.jpg", label: "Lip volume and shape", name: "Rebecca T.", review: "My lips always felt a bit flat for my face. They have a soft fullness to them now and the shape sits nicely with the rest of me." },
  ],
  problem: {
