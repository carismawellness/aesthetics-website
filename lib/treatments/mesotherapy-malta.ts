...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/mesotherapy-malta-ba1-1.jpg", after: "/assets/treatments/mesotherapy-malta-ba1-2.jpg", label: "Thinning crown", name: "Rebecca T.", review: "My part used to show a lot of scalp at the crown. There is real density there now and the regrowth is visible up close." },
    { before: "/assets/treatments/mesotherapy-malta-ba2-1.jpg", after: "/assets/treatments/mesotherapy-malta-ba2-2.jpg", label: "Dull dehydrated skin", name: "Lara M.", review: "My skin had gone flat and a bit tired looking. It feels plumper now and holds a soft, hydrated glow through the day." },
    { before: "/assets/treatments/mesotherapy-malta-ba3-1.jpg", after: "/assets/treatments/mesotherapy-malta-ba3-2.jpg", label: "Cheek sun spots", name: "Nadia P.", review: "The scattered brown spots along my cheek have faded back. The skin reads clearer and the texture feels smoother to touch." },
    { before: "/assets/treatments/mesotherapy-malta-ba4-1.jpg", after: "/assets/treatments/mesotherapy-malta-ba4-2.jpg", label: "Melasma patches", name: "Charlene B.", review: "The darker melasma across my cheeks was hard to cover with makeup. It has lifted a good deal and my tone sits calmer." },
    { before: "/assets/treatments/mesotherapy-malta-ba5-1.jpg", after: "/assets/treatments/mesotherapy-malta-ba5-2.jpg", label: "Freckled cheeks", name: "Sophie D.", review: "My cheeks were busy with freckles and small dark spots. They have softened and the whole face looks more even and settled." },
    { before: "/assets/treatments/mesotherapy-malta-ba6-1.jpg", after: "/assets/treatments/mesotherapy-malta-ba6-2.jpg", label: "Crown hair loss", name: "Daniela C.", review: "The thin patch at the back kept widening on me. It has filled in noticeably and far less scalp shows through now." },
    { before: "/assets/treatments/mesotherapy-malta-ba7-1.jpg", after: "/assets/treatments/mesotherapy-malta-ba7-2.jpg", label: "Cheek redness", name: "Elena V.", review: "My cheek stayed red and bumpy for months. It has settled right down and the skin feels much calmer and clearer." },
    { before: "/assets/treatments/mesotherapy-malta-ba8-1.jpg", after: "/assets/treatments/mesotherapy-malta-ba8-2.jpg", label: "Fine lines", name: "Marie L.", review: "The fine creases around my nose and mouth look softer. My skin feels more hydrated and sits a little fuller than before." },
    { before: "/assets/treatments/mesotherapy-malta-ba9-1.jpg", after: "/assets/treatments/mesotherapy-malta-ba9-2.jpg", label: "Under-eye shadows", name: "Hannah R.", review: "The freckled patches and the shadows under my eyes have eased. My face looks brighter and a lot more rested in photos." },
    { before: "/assets/treatments/mesotherapy-malta-ba10-1.jpg", after: "/assets/treatments/mesotherapy-malta-ba10-2.jpg", label: "Pigment around nose", name: "Grace W.", review: "The pigment around my nose and upper cheeks has faded. My tone looks more even and the skin feels smoother." },
  ],
  precision: {
