...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/mesotherapy-malta-ba1-1.jpg", after: "/assets/treatments/mesotherapy-malta-ba1-2.jpg", label: "Hairline thinning and density", name: "Roberta C.", review: "My parting used to show through so much. After a few sessions the gaps look fuller and I can see little new hairs coming in." },
    { before: "/assets/treatments/mesotherapy-malta-ba2-2.jpg", after: "/assets/treatments/mesotherapy-malta-ba2-1.jpg", label: "Uneven tone and dullness", name: "Daniela B.", review: "My skin always looked a bit tired and patchy. It sits more even now and the brown marks have faded, so I wear less foundation." },
    { before: "/assets/treatments/mesotherapy-malta-ba3-1.jpg", after: "/assets/treatments/mesotherapy-malta-ba3-2.jpg", label: "Skin hydration and glow", name: "Elena M.", review: "I booked this before a wedding. The skin boosters left my face looking plumper and a bit dewy, exactly what I wanted." },
    { before: "/assets/treatments/mesotherapy-malta-ba4-1.jpg", after: "/assets/treatments/mesotherapy-malta-ba4-2.jpg", label: "Melasma on the cheeks", name: "Christine A.", review: "The dark melasma patches on my cheeks had bothered me for years. They have lifted a fair bit and the redness has calmed too." },
    { before: "/assets/treatments/mesotherapy-malta-ba5-1.jpg", after: "/assets/treatments/mesotherapy-malta-ba5-2.jpg", label: "Cheek spots and texture", name: "Nadia F.", review: "My cheek had loads of little spots and felt rough to touch. It is smoother now and you barely notice the marks in photos." },
    { before: "/assets/treatments/mesotherapy-malta-ba6-1.jpg", after: "/assets/treatments/mesotherapy-malta-ba6-2.jpg", label: "Crown hair thinning", name: "Mark V.", review: "The thinning at the back was getting hard to ignore. A few months in the crown looks noticeably fuller, my barber even mentioned it." },
    { before: "/assets/treatments/mesotherapy-malta-ba7-1.jpg", after: "/assets/treatments/mesotherapy-malta-ba7-2.jpg", label: "Cheek redness and breakouts", name: "Maria P.", review: "My cheeks were red and breaking out constantly. The skin has settled right down and feels much calmer from day to day." },
    { before: "/assets/treatments/mesotherapy-malta-ba8-1.jpg", after: "/assets/treatments/mesotherapy-malta-ba8-2.jpg", label: "Dryness and fine lines", name: "Juliana S.", review: "At my age the skin had gone quite dry and creased. After the boosters it feels softer and the lines round my eyes look less obvious." },
    { before: "/assets/treatments/mesotherapy-malta-ba9-1.jpg", after: "/assets/treatments/mesotherapy-malta-ba9-2.jpg", label: "Freckling and pigmentation", name: "Steph R.", review: "Years on the beach left me with a lot of sun spots. They have softened off and honestly my under-eye area looks fresher now." },
    { before: "/assets/treatments/mesotherapy-malta-ba10-1.jpg", after: "/assets/treatments/mesotherapy-malta-ba10-2.jpg", label: "Sun spots on the cheeks", name: "Roxanne D.", review: "The freckly sun damage across my nose and cheeks has really settled down. My skin reads clearer now and I am very happy with it." },
  ],
  precision: {
