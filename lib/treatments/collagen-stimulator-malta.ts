...
const t: Treatment = {
  ...
  precision: {
    ...
    areas: [
      { zone: "Tone", icon: "/assets/treatments/collagen-stimulator-malta-icon-tone.png", name: "Cheek Volume", desc: "Targets dark spots, sun damage, and uneven skin tone with controlled chemical exfoliation." },
