...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/collagen-stimulator-malta-ba1-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba1-2.jpg", label: "Uneven cheek tone", name: "Maria C.", review: "The patchy areas on my cheek have evened out and my skin looks a bit firmer and less tired than it used to." },
    { before: "/assets/treatments/collagen-stimulator-malta-ba2-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba2-2.jpg", label: "Skin quality", name: "Elena B.", review: "My whole face looks fresher and a little plumper. The redness across my cheeks has settled and the dull look has lifted." },
    { before: "/assets/treatments/collagen-stimulator-malta-ba3-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba3-2.jpg", label: "Cheek texture", name: "Sophie R.", review: "My cheeks were red and a bit rough for ages. Now the texture feels smoother and the colour reads much calmer." },
    { before: "/assets/treatments/collagen-stimulator-malta-ba4-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba4-2.jpg", label: "Cheek volume", name: "Claire D.", review: "My cheek looks fuller and the flushing has eased. In profile my face reads more defined than it did before." },
    { before: "/assets/treatments/collagen-stimulator-malta-ba5-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba5-2.jpg", label: "Cheek texture", name: "Nadia P.", review: "I had a lot of little red bumps across my cheek. They have settled and the skin feels smooth when I touch it now." },
    { before: "/assets/treatments/collagen-stimulator-malta-ba6-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba6-2.jpg", label: "Facial redness", name: "Hannah M.", review: "The redness over my cheeks is far less obvious and my skin looks more even and a touch firmer in the mirror." },
    { before: "/assets/treatments/collagen-stimulator-malta-ba7-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba7-2.jpg", label: "Forehead lines", name: "James T.", review: "The lines across my forehead have softened and the crease between my brows sits much flatter than it did." },
    { before: "/assets/treatments/collagen-stimulator-malta-ba8-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba8-2.jpg", label: "Under-eye lines", name: "Rita V.", review: "The fine lines around my eye look smoother and the crepey skin underneath has filled out a little. Subtle but real." },
    { before: "/assets/treatments/collagen-stimulator-malta-ba9-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba9-2.jpg", label: "Cheek pores", name: "Andrea S.", review: "My pores around the cheek and nose look tighter and the pink flush has eased. The skin sits more evenly now." },
    { before: "/assets/treatments/collagen-stimulator-malta-ba10-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba10-2.jpg", label: "Cheek redness", name: "Laura K.", review: "The raised pink patch on my cheek has flattened and the redness has calmed. My skin looks smoother and a bit brighter." },
  ],
  precision: {
