...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/collagen-stimulator-malta-ba1-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba1-2.jpg", label: "Cheek tone and pigmentation", name: "Maria C.", review: "The brown patches on my cheek were the thing that bothered me most. A few months on they have faded a lot and the skin looks brighter." },
    { before: "/assets/treatments/collagen-stimulator-malta-ba2-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba2-2.jpg", label: "Skin tone and clarity", name: "Roberta F.", review: "My skin was red and a bit broken out across the cheeks. It calmed down slowly and now it just looks clearer and more even." },
    { before: "/assets/treatments/collagen-stimulator-malta-ba3-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba3-2.jpg", label: "Cheek redness and freshness", name: "Daniela B.", review: "I always looked flushed and a bit tired. The redness has settled and my under-eyes seem fresher, I look more rested in photos now." },
    { before: "/assets/treatments/collagen-stimulator-malta-ba4-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba4-2.jpg", label: "Cheek redness and texture", name: "Elena M.", review: "Honestly I wasn't sure it would help the redness, but my cheek is so much calmer now and the skin feels smoother to touch." },
    { before: "/assets/treatments/collagen-stimulator-malta-ba5-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba5-2.jpg", label: "Skin texture and clarity", name: "Christine A.", review: "My cheek was bumpy and angry looking for ages. It took a bit of patience but the texture is so much finer now and far less red." },
    { before: "/assets/treatments/collagen-stimulator-malta-ba6-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba6-2.jpg", label: "Facial tone and redness", name: "Nadia P.", review: "My face used to look flushed and a little blotchy. Now the tone is more even and the redness across my cheeks has really eased off." },
    { before: "/assets/treatments/collagen-stimulator-malta-ba7-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba7-2.jpg", label: "Forehead lines and skin quality", name: "Mark V.", review: "The lines across my forehead softened and the skin generally looks fresher. Subtle stuff, but people keep telling me I look less tired." },
    { before: "/assets/treatments/collagen-stimulator-malta-ba8-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba8-2.jpg", label: "Eye area smoothness", name: "Stephanie R.", review: "The crepey skin around my eye was creeping in with the years. The area looks smoother and a bit fuller now, it sits much better under makeup." },
    { before: "/assets/treatments/collagen-stimulator-malta-ba9-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba9-2.jpg", label: "Pore and texture refinement", name: "Julia S.", review: "My pores looked huge and the cheek felt rough. A few sessions in, the texture is finer and the redness around my nose calmed right down." },
    { before: "/assets/treatments/collagen-stimulator-malta-ba10-1.jpg", after: "/assets/treatments/collagen-stimulator-malta-ba10-2.jpg", label: "Cheek redness and texture", name: "Nicola G.", review: "I wanted my cheek to look calmer without anything dramatic. The redness settled, the few spots cleared, and it still looks completely like me." },
  ],
  precision: {
