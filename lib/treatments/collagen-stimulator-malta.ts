...
const t: Treatment = {
  ...
  precision: {
    ...
    areas: [
      ...
      { zone: "Temples", icon: "/assets/treatments/collagen-stimulator-malta-icon-temples.png", name: "Temple Hollows", desc: "Fills the temple area where volume loss creates a hollowed, aged appearance over time." },
  ...
  experience: {
    ...
    steps: [
      ...
      { title: "Targeted Treatments", desc: "Your doctor administers the collagen stimulator with fine, precise injections, quick, comfortable, and no downtime.", image: "/assets/treatments/botox-step3.png" },
      { title: "Ongoing Review & Adjustment", desc: "Your doctor monitors your response and refines the plan to ensure natural collagen stimulator results over time.", image: "/assets/treatments/botox-step4.png" },
    ],
  },
  prepAftercare: {
    ...
    cards: [
      {
        icon: "/assets/treatments/collagen-stimulator-malta-icon-before.png",
        label: "Before",
        lead: "Preparation helps ensure an effective treatment.",
        points: [
          "Share your full medical and treatment history",
      ...
      {
        icon: "/assets/treatments/collagen-stimulator-malta-icon-during.png",
        label: "During",
        lead: "Product is carefully placed to stimulate your own collagen.",
        points: [
          "Treatment areas are assessed, marked, and numbed",
          "Product is injected into targeted facial planes",
          "Gentle massage follows to distribute evenly",
          "Session takes 30–45 minutes",
        ],
      },
      {
        icon: "/assets/treatments/collagen-stimulator-malta-icon-after.png",
        label: "After",
        lead: "Post-treatment care is simple. Product is carefully placed to stimulate your own collagen.",
        points: [
          "Massage treated areas as directed for 5 days",
          "Mild swelling and tenderness for 3–5 days",
          "Avoid intense heat and activity for 48 hours",
  ...
  trusted: {
    ...
    points: [
      ...
      { title: "Personalised Treatment Plans", desc: "Your collagen stimulator plan is designed to enhance, never overcorrect." },
      { title: "Clinically Approved Products", desc: "Clinically Approved Products — CE-marked, clinically approved collagen stimulator and evidence-based protocols." },
