...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba1-2.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba1-1.jpg", label: "Dull skin and texture", name: "Roberta M.", review: "My skin felt tired and a bit rough, especially across the cheeks. After the facial it looks fresher and the texture is so much smoother." },
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba2-1.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba2-2.jpg", label: "Cheek congestion and breakouts", name: "Mark B.", review: "I always get blackheads and the odd spot along my cheek. A few sessions in and it is clearly calmer, the skin feels far less clogged." },
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba3-1.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba3-2.jpg", label: "Dull, congested skin", name: "Christine A.", review: "Around my nose and cheek it always looked dull and a little bumpy. Now the skin feels clean and the glow holds up longer than I thought." },
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba4-1.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba4-2.jpg", label: "Fine lines and dehydration", name: "Daniela C.", review: "The crepey little lines near my smile used to bother me. After the hydrating facial my cheek looks plumper and softer, and the lines settled down." },
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba5-1.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba5-2.jpg", label: "Pigmentation and redness", name: "Elena V.", review: "Had freckly patches and some redness across my cheek. The tone reads much more even now and the redness has quietened, really pleased with it." },
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba6-2.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba6-1.jpg", label: "Dull, congested skin", name: "Nadia P.", review: "Before, my skin looked flat and a touch congested. The deep clean made a genuine difference and the glow afterwards felt real, not just shiny." },
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba7-1.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba7-2.jpg", label: "Cheek redness and congestion", name: "Maria F.", review: "My cheek and nose stayed red and clogged no matter what. After treatment the redness eased off and the skin feels properly clean, not stripped." },
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba8-1.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba8-2.jpg", label: "Uneven tone and texture", name: "Julia S.", review: "I have freckles and a few uneven patches near my jaw. The facial smoothed the texture and evened things out, my skin honestly feels lovely." },
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba9-1.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba9-2.jpg", label: "Pigmentation and dullness", name: "Sandra R.", review: "The darker patches on my cheeks looked heavier than they really were. They have faded a fair bit and my whole tone reads brighter and clearer." },
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba10-1.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba10-2.jpg", label: "Dull, tired skin", name: "Christabelle G.", review: "My skin had gone tired and a bit grey looking. After the facial it has a fresh, even glow and the under-eye area looks far more rested." },
  ],
  problem: {
