...
const t: Treatment = {
  ...
  beforeAfter: [
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba1-1.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba6-1.jpg", label: "Brighter under-eye skin", name: "Ella M.", review: "The pink shadow under my eyes settled and my skin looks fresher and a bit more even across the cheeks." },
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba1-2.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba6-2.jpg", label: "Smoother sun-damaged skin", name: "Rita C.", review: "My skin felt rough from years in the sun, now the surface is softer and the tone looks calmer." },
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba2-1.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba7-1.jpg", label: "Clearer cheek skin", name: "Daniel B.", review: "The spots and clogged pores on my cheek have settled and the skin feels a lot cleaner to the touch." },
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba2-2.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba7-2.jpg", label: "Calmer blemish-prone skin", name: "Sophie L.", review: "The breakout marks across my cheeks have faded and the redness around my nose looks much quieter now." },
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba3-1.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba8-1.jpg", label: "Refreshed central face", name: "Marta V.", review: "The dark shadows around my nose and eyes have lifted and the middle of my face looks more awake." },
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba3-2.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba8-2.jpg", label: "Softer cheek lines", name: "Carmen P.", review: "The creases by my eye and cheek look softer and the skin holds moisture better than it used to." },
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba4-1.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba9-1.jpg", label: "Smoother lip area", name: "Nadia F.", review: "The little lines above my lip are less obvious and the skin around my mouth feels plumper and hydrated." },
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba4-2.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba9-2.jpg", label: "Even cheek tone", name: "Hannah K.", review: "The freckling and red patches along my cheek and jaw look more even and the skin feels smoother." },
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba5-1.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba10-1.jpg", label: "Brighter even tone", name: "Lucia D.", review: "The patchy spots on my cheeks have lightened and my whole face looks brighter and more rested." },
    { before: "/assets/treatments/4-in-1-hydrafacial-glow-ba5-2.jpg", after: "/assets/treatments/4-in-1-hydrafacial-glow-ba10-2.jpg", label: "Refreshed under-eyes", name: "Gemma R.", review: "The puffiness under my eyes looks lighter and the folds beside my mouth seem softer and better hydrated." },
  ],
  problem: {
