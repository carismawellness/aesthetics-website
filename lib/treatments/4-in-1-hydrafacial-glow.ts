...
const t: Treatment = {
  ...
  category: "Package",
  hero: {
    title: "4-in-1 HydraFacial Glow Package Malta — Radiant Skin in One Session",
  ...
  beforeAfterTitle: "Real HydraFacial Glow Results — Before and After at Carisma Aesthetics",
  beforeAfter: [
    { before: "/assets/treatments/hydrafacial-ba1-before.png", after: "/assets/treatments/hydrafacial-ba1-after.png" },
  ],
  precision: {
    title: "What Is the 4-in-1 HydraFacial Glow Package?",
  ...
  suitability: {
    title: "Who Is a Good Candidate for the HydraFacial Glow Package?",
    suitableFor: [
  ...
  experience: {
    title: "How Does the HydraFacial Glow Package Work — Step by Step",
    steps: [
      {
      ...
      {
        title: "Step 2 — Your Treatment Session",
  ...
  trusted: {
    title: "Medically Qualified Practitioners — Safe HydraFacial Glow in Malta",
    asSeenOn: [
  ...
  difference: {
    ...
    title: "HydraFacial Glow Package Pricing in Malta — From €99",
  ...
  faqTitle: "Have Questions About the HydraFacial Glow Package in Malta?",
  faq: [
