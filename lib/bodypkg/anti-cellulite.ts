...
export const antiCellulite: PackageContent = {
  id: 'anti-cellulite',
  ...
  heroVideo: 'https://video.wixstatic.com/video/87fc13_acf34576a18744be8eff908bf00f55a6/720p/mp4/file.mp4',
  ...
  benefits: [
    { icon: W + '87fc13_3b19a298b5204a2283ceb70900d421b0~mv2.png', title: 'TARGETED CELLULITE CONTOURING', body: 'Focus on areas most affected by cellulite — thighs, bum and hips — using targeted VelaShape vacuum roller treatments to improve texture and contour.' },
    { icon: W + '87fc13_83de975f116646a795c9db7ebdc3b4be~mv2.png', title: 'MULTI-ACTION SMOOTHING APPROACH', body: 'CelluLift combines VelaShape vacuum roller sessions with lymphatic drainage massage to improve circulation, reduce fluid retention, and smooth the appearance of cellulite.' },
    { icon: W + '87fc13_b4783b8ab4ad480fa01394e449f91d34~mv2.png', title: 'Expert DESIGNED PLAN', body: 'Your in-person consultation determines the right areas to treat, how sessions are scheduled, and what realistic tightening results you can expect.' },
  ...
  dualMini: [
    ...
    { icon: W + '87fc13_c4cf7001e0324fbd84551191d2a27bd1~mv2.png', title: 'High-Value starter Access', body: 'A complete cellulite smoothing protocol at a reduced introductory price, ideal for trying CelluLift without long-term commitment.' },
  ],
  dualIncludes: [
    '4x Anti Cellulite sessions with the VelaShape (€400)',
    '4x access to spa & fitness facilities (€140)',
  ...
  evidence: [
    ...
    {
      img: W + '87fc13_377a0ff5d9774c708ec911dee12739ce~mv2.png',
      tag: 'Moderate evidence',
