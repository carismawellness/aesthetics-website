...
export const fatFreezing: PackageContent = {
  id: 'fat-freezing',
  ...
  benefits: [
    { icon: W + '87fc13_31a3925719b446858712ee300fd07661~mv2.png', title: 'TARGETED CONTOURING', body: 'Focus on your biggest trouble spot first so love handles, lower belly or double chin start to look smoother in clothes and photos.' },
    { icon: W + '87fc13_03c8382fd1434f919cf94b1d664d494c~mv2.png', title: 'DUAL ACTION FAT REDUCTION', body: "Combine Malta's first CoolSculpting technology with targeted fat dissolving injections for a more complete result than using either alone." },
    { icon: W + '87fc13_b4783b8ab4ad480fa01394e449f91d34~mv2.png', title: 'EXPERT DESIGNED PLAN', body: 'Your in person consultation maps out which area to treat, how to combine both methods and what to expect from your results.' },
    { icon: W + '87fc13_729173bc08764a74bee017b037d95d5b~mv2.png', title: 'SAFE AND CLINICALLY CERTIFIED', body: 'Treatments are performed by medical professionals using EU approved, clinically proven body contouring technology with minimal downtime.' },
  ],
  ...
  dualMini: [
    ...
    { icon: W + '87fc13_c4cf7001e0324fbd84551191d2a27bd1~mv2.png', title: 'HIGH-VALUE STARTER ACCESS', body: '€550 worth of treatments and clinic credit for €199, with the option to upgrade later.' },
  ],
  dualIncludes: [
  ...
  evidence: [
    {
      img: W + '87fc13_e49f864318254f4b86704307b14ca6d8~mv2.png',
    ...
    {
      img: W + '87fc13_8094f30674bc47208fac989787bf0557~mv2.png',
      tag: 'Targeted effect',
    ...
    {
      img: W + '87fc13_3ffa5b43365244309f4c746206cc1ecc~mv2.png',
      tag: 'Synergy',
