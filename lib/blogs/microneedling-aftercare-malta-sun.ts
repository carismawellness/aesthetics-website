...
const post: BlogPost = {
  slug: 'microneedling-aftercare-malta-sun',
  title: 'Microneedling Aftercare Malta Sun: How to Protect Your Skin After Treatment',
  metaTitle: 'Microneedling Aftercare Malta Sun | Carisma Aesthetics',
  metaDescription: 'After microneedling in Malta, sun protection is non-negotiable. Our aftercare guide covers SPF, timing, and what to avoid in the Mediterranean heat.',
  ...
  content: [
    ...
    },
    {
      type: 'heading',
      level: 3,
      text: 'What SPF should I use after microneedling?',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      html: `If you are ready to understand exactly what is possible for your skin, we would love to meet you. Book your free consultation at Carisma Aesthetics and let us walk you through everything, from what to expect during your session to how to protect your results under Malta's sun.`,
    },
    {
      type: 'cta',
