...
const post: BlogPost = {
  slug: 'how-long-do-lip-fillers-last-malta',
  title: 'How Long Do Lip Fillers Last in Malta?',
  metaTitle: 'How Long Do Lip Fillers Last Malta | Carisma Aesthetics',
  metaDescription: 'Lip fillers in Malta typically last 6 to 12 months. Discover what affects longevity, how to make them last longer, and the best time to top up.',
  ...
  content: [
    ...
    {
      type: 'paragraph',
      html: `If you are in your mid-thirties to mid-forties and have been maintaining your results for a few years, you have likely already found your personal rhythm. Many patients at this stage find their results hold closer to ten to twelve months, particularly if they have been consistent with maintenance and sun protection. Your practitioner can assess whether slight adjustments in volume or product choice could extend your intervals.`,
    },
    {
      type: 'paragraph',
      html: `If you are looking to restore volume that has changed over time, you may benefit from a more structured plan that builds results over two or three appointments rather than one larger session. Gradual, layered enhancement tends to look most natural and gives the tissue time to respond. For further guidance on treatment safety and what to consider when planning a maintenance schedule, <a href="https://baaps.org.uk/patients/procedures/29/dermal_fillers" target="_blank" rel="noopener" style="color:var(--teal);text-decoration:underline;">BAAPS: safety information on lip fillers</a> is a trusted resource from the British Association of Aesthetic Plastic Surgeons.`,
    },
    {
      type: 'paragraph',
    ...
    },
    {
      type: 'heading',
      level: 2,
      text: 'Frequently Asked Questions About Lip Fillers in Malta',
    },
    {
      type: 'heading',
      level: 3,
      text: 'How long do lip fillers last for a first-time patient?',
    },
    {
      type: 'paragraph',
