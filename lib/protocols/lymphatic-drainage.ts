...
export const lymphaticDrainage: ProtocolData = {
  ...
  trusted: {
    ...
    pressLogos: PRESS,
    features: [
      { icon: `${A}/ld-feat1.png`, label: "MEDICALLY GUIDED APPROACH", desc: "Your lymphatic drainage treatment is overseen by medical professionals, with careful assessment of your health history to ensure the therapy is safe, appropriate, and effective for your body." },
      { icon: `${A}/ld-feat2.png`, label: "LYMPHATIC FLOW & DETOX SUPPORT", desc: "Gentle, targeted techniques are used to stimulate lymph flow, helping reduce fluid retention, support natural detoxification, and relieve feelings of heaviness and congestion." },
      { icon: `${A}/ld-feat3.png`, label: "Expert-DESIGNED TREATMENT PLAN", desc: "Your in-person consultation helps determine suitability, treatment frequency, and realistic outcomes — ensuring lymphatic drainage is delivered as part of a structured, personalised wellness plan." },
      { icon: `${A}/ld-feat4.png`, label: "SAFE AND CLINICALLY CERTIFIED", desc: "All treatments are performed under clinical standards, using medically approved techniques, with professional supervision to prioritise comfort, safety, and results at every stage." },
    ],
  },
  eligibility: {
    kicker: "what is all the hype with debloating",
    heading: "Benefits of lymphatic drainage",
    image: `${A}/ld-eligibility.png`,
    ...
    cards: [
      {
        ...
        keyResults: ["Gentle technique", "Targets fluid build-up", "Best in structured plan"],
        evidence: "Moderate-high evidence",
      },
      {
        image: `${A}/ld-research2.png`,
        ...
        keyResults: ["Recovery support", "Comfort-focused", "Timing matters"],
        evidence: "Moderate evidence",
      },
      {
        image: `${A}/ld-research3.png`,
        ...
        keyResults: ["De-bloating support", "Travel & lifestyle friendly", "Works best consistently"],
        evidence: "Moderate evidence",
      },
      {
        image: `${A}/ld-research4.png`,
        ...
        keyResults: ["Gentle & non-invasive", "Requires basic screening", "Comfort-first approach"],
        evidence: "Moderate evidence",
      },
    ],
    cta: "CLAIM your SPOT NOW",
