...
export const post: BlogPost = {
  ...
  "content": [
    ...
    {"type": "list", "items": ["Daily broad-spectrum SPF 50+ sunscreen", "Antioxidant-rich skincare (vitamin C, E, ferulic acid)", "Protective clothing and accessories", "Regular skin checks with a dermatologist"]},
    {"type": "cta", "label": "Schedule a Skin Assessment", "href": "/contact"}
  ],
  "internalLinks": []
};
