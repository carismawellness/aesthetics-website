...
export const post: BlogPost = {
  ...
  "content": [
    ...
    },
    {
      "type": "heading",
      "level": 2,
      "text": "How Your Skin is Structured"
    },
    {
      "type": "paragraph",
      "html": "Your skin has three main layers: the epidermis (outermost), the dermis (middle), and the hypodermis (deep fat layer). Each layer serves a specific function, and understanding this structure helps explain why different treatments target different concerns."
    },
    {
      "type": "heading",
      "level": 2,
      "text": "Surprising Skin Facts"
    },
    {
      "type": "list",
      "items": [
