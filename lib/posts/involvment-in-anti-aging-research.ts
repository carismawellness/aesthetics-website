...
export const post: BlogPost = {
  ...
  "readTime": 5,
  "coverImage": "",
  "excerpt": "The field of anti-aging research is constantly evolving with new treatments and breakthroughs.",
  "content": [
    {
      "type": "paragraph",
      "html": "This post is pending content from the Wix blog. Please check back soon.",
    },
  ],
  "internalLinks": []
};
