...
function TestimonialCard({ t }: { t: Testimonial }) {
  ...
  return (
    <div style={{ background: '#fff', borderRadius: 16, padding: '20px 10px', margin: '0 10px', boxSizing: 'border-box' }}>
      ...
      <div style={{ background: 'linear-gradient(178deg, #ecf2f2 42%, #96b2b2 100%)', borderRadius: 16, padding: '15px', paddingTop: 70, marginTop: -91 }}>
        <p
          style={{
  ...
  return (
    <div style={{ backgroundColor: '#ffffff', fontFamily: BODY }}>
      ...
      <section style={{ paddingTop: 32, paddingBottom: 56 }}>
        <div style={{ ...CONTAINER, maxWidth: 1180 }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 22 }} className="fr-benefits">
            {c.benefits.map((b) => (
              <div key={b.title} style={{ background: 'linear-gradient(150deg, #ecf2f2 0%, #96b2b2 100%)', borderRadius: '22px 22px 0 22px', padding: '28px 24px 34px' }}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
      ...
      <section style={{ ...CONTAINER, maxWidth: 1120, paddingTop: 40, paddingBottom: 56 }}>
        <div style={{ position: 'relative', overflow: 'hidden', background: 'linear-gradient(160deg, #ecf2f2 0%, #96b2b2 100%)', borderRadius: 24, padding: '48px 48px 44px' }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
      ...
      <section style={{ position: 'relative', paddingTop: 48, paddingBottom: 64, overflow: 'hidden' }}>
        ...
        <div style={{ ...CONTAINER, position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ marginTop: 36, marginLeft: 'auto', marginRight: 'auto', maxWidth: 560, background: 'linear-gradient(150deg, #ecf2f2 0%, #96b2b2 100%)', borderRadius: 18, padding: '34px 36px' }}>
      ...
      <section style={{ paddingTop: 32, paddingBottom: 56 }}>
        <div style={CONTAINER}>
          ...
          <div style={{ marginTop: 36, background: 'linear-gradient(150deg, #ecf2f2 0%, #96b2b2 100%)', borderRadius: 20, padding: 36, display: 'grid', gridTemplateColumns: '0.85fr 1.15fr', gap: 40, alignItems: 'center' }} className="fr-2col">
      ...
      <section style={{ paddingTop: 32, paddingBottom: 56 }}>
        <div style={CONTAINER}>
          ...
          <div style={{ marginTop: 36, background: 'linear-gradient(150deg, #ecf2f2 0%, #96b2b2 100%)', borderRadius: 22, padding: 22, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 22 }} className="fr-2col">
            ...
            <div style={{ backgroundColor: '#fff', borderRadius: 16, padding: '30px 30px' }}>
              ...
              <div style={{ background: 'linear-gradient(150deg, #ecf2f2 0%, #96b2b2 100%)', borderRadius: 12, padding: '18px 20px' }}>
      ...
      <section style={{ paddingTop: 32, paddingBottom: 56 }}>
        <div style={CONTAINER}>
          ...
          {/* pricing card */}
          <div style={{ marginTop: 40, background: 'linear-gradient(150deg, #ecf2f2 0%, #96b2b2 100%)', borderRadius: 22, padding: 22, display: 'grid', gridTemplateColumns: '1.1fr 0.9fr', gap: 22, alignItems: 'stretch' }} className="fr-2col">
            ...
            {c.evidence.map((e, i) => {
              ...
              return (
                <div key={e.title} style={{ position: 'relative', paddingTop: 16, gridColumn: centerLast ? '1 / -1' : 'auto', maxWidth: centerLast ? 560 : undefined, justifySelf: centerLast ? 'center' : 'stretch', width: centerLast ? '100%' : undefined }}>
                  ...
                  <div style={{ background: 'linear-gradient(180deg, #ecf2f2 0%, #96b2b2 100%)', borderRadius: 16, marginTop: -70, padding: '92px 30px 30px', position: 'relative', zIndex: 1 }}>
