  ...
  if (show) {
    return (
      <iframe
        ...
        style={{ ...SHARED_BOX, border: 0, filter: "saturate(0.9) contrast(1.02)" }}
      />
    );
  }
  ...
  return (
    <button
      ...
      style={{
        ...
        overflow: "hidden",
        background:
          "linear-gradient(150deg, var(--teal-100, #deebeb) 0%, var(--gray-100, #f2f5f5) 55%, #ffffff 100%)",
      }}
    >
      <span
        style={{
      ...
      >
        <span style={{ display: "grid", justifyItems: "center", gap: 8 }}>
          <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#245052" strokeWidth="1.6" aria-hidden>
            <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />
            <circle cx="12" cy="10" r="3" />
          </svg>
          <span style={{ fontSize: 14, letterSpacing: "0.04em" }}>
            Carisma Aesthetics, St Julian&apos;s
          </span>
          <span style={{ fontSize: 12, opacity: 0.7 }}>Tap to load map</span>
        </span>
      </span>
    </button>
  );
