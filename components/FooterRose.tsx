 ...
 * half off the edge. Rendered as a CSS mask filled with a washed teal so it
 * blends subtly into the footer gradient. Drifts gently with the cursor
 * (parallax). Purely presentational; disabled under prefers-reduced-motion.
 *
 * Ported 1:1 from the Carisma Slimming footer rose — same proportions and
 * placement — recoloured green → teal (#96B2B2 / --teal) for Aesthetics.
 */
