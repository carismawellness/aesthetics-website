...
function GoogleRating() {
  return (
    <div className="flex items-center flex-wrap gap-x-2 gap-y-1" style={{ fontSize: "13px", color: "var(--label)" }}>
      ...
      <span className="font-display" style={{ color: TEAL_DEEP, fontSize: "11px", letterSpacing: "0.1em" }}>FROM 200+ REVIEWS</span>
    </div>
  );
}
  ...
  return (
    <>
      ...
      <PageHero
        ...
        proof={{ rating: "4.9", reviews: "200+", statValue: "35+", statLabel: "years in wellness", awardText: "#1 Voted Clinic\nMalta Healthcare Awards" }}
      />
