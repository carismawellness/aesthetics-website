...
/* Full-bleed Three.js particle canvas — mounted behind quiz results hero.
   Uses additive blending over dark background for a luxury bokeh effect. */
export default function ParticleScene() {
  ...
  useEffect(() => {
    ...
    const palette: THREE.Color[] = [
      new THREE.Color('#DEEBEB'),
      new THREE.Color('#96B2B2'),
      new THREE.Color('#4F7373'),
      new THREE.Color('#ffffff'),
      new THREE.Color('#B0CFCF'),
      new THREE.Color('#C8E2E2'),
    ];
    ...
    for (let i = 0; i < COUNT; i++) {
      ...
      /* Small bright (most) → medium glowing → large soft bokeh */
    ...
    /* ── Custom shader — round glowing particles ── */
    ...
    const animate = (t: number) => {
      ...
      // Ultra-slow global rotation for depth
