...
export default function QuizIcon3D() {
  ...
  useEffect(() => {
    ...
    /* ── Bloom halo layers (additive, larger spheres) ─────────────────── */
    ...
    const animate = (ms: number) => {
      ...
      // Ring spins (each different speed/direction)
      ring1.rotation.z =  t * 0.60;
      ring2.rotation.z = -t * 0.45;
      ring3.rotation.z =  t * 0.33;

      // Wireframe counter-rotates for parallax
      ...
      // Nodes orbit opposite directions
