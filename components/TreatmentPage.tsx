...
export default function TreatmentPage({ t }: { t: Treatment }) {
  ...
  return (
    <>
      ...
      <section style={{ background: "#fff", padding: "44px 0 64px" }}>
        <div className="container">
          ...
          <div style={t.hero.bgImage
            ...
            : { borderRadius: "26px", backgroundImage: "url('/assets/hero-bg.png')", backgroundSize: "cover", backgroundPosition: "bottom center", boxShadow: "0 4px 40px rgba(0,0,0,0.06)", padding: "clamp(28px,3.6vw,52px)" }}>
